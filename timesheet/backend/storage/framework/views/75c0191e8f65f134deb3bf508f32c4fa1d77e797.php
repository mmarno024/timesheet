                    ...
                    <tr>
                        <td rowspan="2">
                            <a href="<?php echo e(url('home')); ?>">
                                <img
                                    src="http://tatonas.co.id/admin/p/libftp/{{ cek_plant . image != null ? cek_plant . image : 'uploads/sys_syplant/default_logo.png' }}"></img>
                            </a>
                        </td>
                        <td rowspan="2">&nbsp;</td>
...
<?php /**PATH C:\laragon\www\kalsel\bpbd\admin\backend\resources\views/layouts/common/coloradmin/nav_top.blade.php ENDPATH**/ ?>