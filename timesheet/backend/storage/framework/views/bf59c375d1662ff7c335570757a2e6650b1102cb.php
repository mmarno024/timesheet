                ...
                <form action="#" name="frm" id="frm">
                    <div class="row">
                        <div class="col-sm-3">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-btn">
                                    <button ng-show="f.crud=='c'" class="btn btn-success btn-sm" type="button"
                    ...
                    <div>
                        <div class="list-group">
                                    ...
                                    <div class="col-sm-10 m-0 p-0">
                                        <table class="table table-condensed table-bordered m-0"
                                            ...
                                            <tr>
                                                ...
                                                <td width="85%" class="text-success p-0">
                            ...
                            <button type="button" class="btn btn-sm btn-success" ng-click="addRow();">Tambah Sensor</button>
                        </div>
                    </div>
                    <hr>
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\psda\psda2\backend\resources\views/trs/local/mst_hardware/mst_hardware_frm.blade.php ENDPATH**/ ?>