                ...
                <div class="panel panel-inverse" data-sortable-id="index-6">
                    ...
                    <div class="panel-body p-10">
                        <label ng-repeat="v in data_sensor" class="m-r-2"
                            ng-class="{'label label-primary':v.kd_logger=='1','label label-success':v.kd_logger=='2','label label-warning':v.kd_logger=='8' || v.kd_logger=='9'}"
                            style="font-size:13px;font-weight:normal">{{ v . nm_sensor }}</label>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\webmon\monitoring\webadm\backend\resources\views/sys/system/sfhome.blade.php ENDPATH**/ ?>