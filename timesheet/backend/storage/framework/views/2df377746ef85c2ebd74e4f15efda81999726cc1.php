...
<head>
    ...
    <script src="<?php echo e(url('/js/apps/sfAngular.js?ver=2019.03.12')); ?>"></script>
...
<body ng-app="sfApp" ng-controller="topCtrl" id="topCtrl">
    ...
    <div id="page-container" class="page-container fade  page-without-sidebar page-header-fixedxxx">
        <!-- begin #content -->
        <div ng-app="sfApp" ng-controller="mainCtrl" id="mainCtrl" class="content p-0">
            <div>
...
<?php /**PATH C:\xampp\htdocs\tatonas\besai\backend\resources\views/layouts/colortv.blade.php ENDPATH**/ ?>