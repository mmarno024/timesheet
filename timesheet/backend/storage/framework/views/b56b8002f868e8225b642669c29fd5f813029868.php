                ...
                <div class="pull-right">
                    <div ng-show="f.tab=='list'">
                        <div class="input-group">
                            <div class="btn-group">
                                <button type="button" id="btn-new" class="btn btn-sm btn-primary" ng-click="oSyncLdap()"
                                    title="Syncronize LDAP to Database"> LDAP</button>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <input type="text" ng-model="h.userid" id="h_userid" class="form-control input-sm" required
                                maxlength="15" ng-readonly="f.crud!='c'">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="text" ng-model="h.def_plant" id="h_def_plant" class="form-control input-sm"
                                maxlength="30" readonly="">
                            <label>Default Shift</label>
                            <select ng-model="h.def_shift" id="def_shift" class="form-control input-sm">
                                <option
                                    ng-repeat="v in [['A','Shift A'],['B','Shift B'],['C','Shift C'],['N','Non Shift'],['','Other']]"
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\webmon\monitoring\backend\resources\views/sys/syuser/syuser_frm.blade.php ENDPATH**/ ?>