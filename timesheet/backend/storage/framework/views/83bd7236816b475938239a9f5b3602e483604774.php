            ...
            function(
                    ...
                    SfService.httpGet("trs_local_mst_logger_data", {
                        ...
                        angular.forEach($scope.loggerData, function(item, i) {
                            angular.forEach(item.hardware, function(item1, i1) {
                                ...
                                angular.forEach(item1.sensor, function(item2, i2) {
                                    $scope.content += "<tr>";
                                    $scope.satuan = item1.satuan == null ||
                                        item1.satuan == '' ? item2.rel_sensor
                                        .satuan : item1.satuan;
                                    $scope.content +=
                                    ...
                                    $scope.content +=
                                        ...
                                        item2.cek_val.min_val + "</td>";
                                    $scope.content +=
                                        "<td style='font-size:10px' class='bg-red text-white text-right'>" +
                                        item2.cek_val.max_val + "</td>";
                                    $scope.content += "</tr>";
                                });

                                $scope.content += '</table>';
                                $scope.content +=
                                    "<table width='100%'><tr><td style='font-size:10px' class='text-warning' align='left'><i class='fa fa-calendar'>&nbsp;</i><i>" +
                                    item1.updated_at +
                                    ...
                                    item1.kd_logger + "&hw=" + item1.kd_hardware +
                ...
                $scope.oView = function(lg, hw) {
                    $scope.content =
                        ...
                        .kd_hardware + " : " + $scope.loggerData[lg].hardware[hw].uid + "</b></div>";
                    $scope.content +=
                        "<table class='table table-condensed'>";
                    $scope.content += "<tr><td colspan='6'>";
                    $scope.content += "<table width='100%'>";
                    ...
                    angular.forEach($scope.loggerData[lg].hardware[hw].sensor, function(item1, i1) {
                        $scope.content += "<tr>";
                        $scope.satuan = $scope.loggerData[lg].hardware[hw].satuan == null || $scope
                            .loggerData[lg].hardware[hw].satuan == '' ? item1.rel_sensor.satuan :
                    ...
                    $scope.content +=
                        ...
                        "</i></td><td style='font-size:10px' class='text-primary' align='right'><i class='fa fa-arrow-circle-right'>&nbsp;</i><i><a href='<?php echo url('trs_local_trs_raw_detail'); ?>?lg = " +
                        $scope.loggerData[lg].hardware[hw].kd_logger + "&hw=" + $scope.loggerData[
                            lg]
                    ...
                    if (lg == '1') {
                        $scope.mark.bindPopup($scope.pop, {
                            ...
                            .openPopup()
                            .on($scope.map.flyTo([parseFloat($scope.loggerData[lg].hardware[hw].latitude),
                                parseFloat(
...
<?php echo $__env->make('layouts.colorfront', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\palu\palu1\backend\resources\views/welcome.blade.php ENDPATH**/ ?>