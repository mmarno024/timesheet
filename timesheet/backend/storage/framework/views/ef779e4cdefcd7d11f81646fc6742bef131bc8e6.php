                ...
                <div id="div1" class="table-responsive">
                    <table ng-table="tableList" show-filter="false" class="table table-condensed table-hover"
                        ...
                        <tr ng-repeat="v in $data">
                            <td style="padding:6px;" title="'Kode Kabupaten'" filter="{kd_kabupaten: 'text'}" sortable="">
                                {{ v . kd_kabupaten }}</td>
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/admin/backend/resources/views/trs/local/mst_kabupaten/mst_kabupaten_frm.blade.php ENDPATH**/ ?>