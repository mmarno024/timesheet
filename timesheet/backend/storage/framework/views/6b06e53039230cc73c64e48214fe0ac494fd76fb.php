                    ...
                    <div class="row" ng-show="f.tab=='list'">
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-3">
                            ...
                            <select ng-model="q.vqmode" class="form-control input-sm" style="background:aquamarine">
                                <option ng-repeat="vq in ['Interval Kirim','Perjaman','Harian','Bulanan']">{{ vq }}</option>
                            </select>
                        </div>
                        <div class="col-lg-2 col-md-3 col-sm-3">
    ...
    <script>
        app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope,
            ...
            $scope.oPdf = function(hardware,date1,date2,vqmode) {
                window.open('trs_local_trs_raw_detail_pdf?hw=' + hardware + '&t1=' + moment(date1).format('YYYY-MM-DD 00:00:00') + '&t2=' + moment(date2).format('YYYY-MM-DD 23:59:59') + '&vq=' + vqmode);
            }
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/admin/backend/resources/views/trs/local/trs_raw/trs_raw_frm_detail.blade.php ENDPATH**/ ?>