...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="pull-right">
                        ...
                        <div ng-show="f.tab=='frm'">
                            ...
                            <span ng-if="f.crud!='c'"> <?php $__env->startComponent('layouts.common.coloradmin.chat', ['route' =>
                                'trs_local_trs_mapimage', 'id' => 'h.id']); ?> <?php echo $__env->renderComponent(); ?> </span>
                        </div>
                    </div>
                </div>
                                        ...
                                        <tr ng-repeat="v in d1 | filter:q_filter">
                                            ...
                                            <td class="p-0">
                                                <select class="form-control input-sm no-border-text" ng-model="v.icon">
                                                    <option ng-repeat="va in ['seven_segmen']" ng-value="va">
                                                        {{ va }}
                                                    </option>
                                                </select>
                                            </td>
    ...
    <script src="<?php echo e(url('neptuneparalax/assets/plugins/fabric/fabric.min.js?ver=2019.07.17')); ?>"></script>
    <script>
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\besai\backend\resources\views/trs/local/trs_mapimage/trs_mapimage_frm.blade.php ENDPATH**/ ?>