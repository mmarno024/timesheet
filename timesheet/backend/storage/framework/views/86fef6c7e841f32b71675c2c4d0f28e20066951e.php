                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <select ng-model="h.def_plant" id="h_def_plant" class="form-control input-sm" tabindex="8">
                                <option ng-repeat="v in plantAll" ng-value="v.plant">{{ v . note }} | {{ v . plantname }}
                                </option>
                            </select>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kalsel\psda\admin\backend\resources\views/sys/syuser/syuser_frm.blade.php ENDPATH**/ ?>