<!-- ------------------------------------------------------------------------------- -->
<?php $__env->startSection('title'); ?>City <?php $__env->stopSection(); ?>
<!-- ------------------------------------------------------------------------------- -->
                ...
                <div id="div1" class="table-responsive">
                    <table ng-table="tableList" show-filter="false" class="table table-condensed table-hover"
                        ...
                        <tr ng-repeat="v in $data">
                            <td style="padding:6px;" title="'City'" filter="{kd_kabupaten: 'text'}" sortable="">
                                {{ v . kd_kabupaten }}</td>
                            <td style="padding:6px;" title="'Provice'" filter="{nm_provinsi: 'text'}" sortable="">
                                {{ v . nm_provinsi }}</td>
                            <td style="padding:6px;" title="'City Name'" filter="{nm_kabupaten: 'text'}" sortable="">
                                {{ v . nm_kabupaten }}</td>
                        </tr>
                    </table>
                </div>
            ...
            <div ng-show="f.tab=='frm'">
                <form action="#" name="frm" id="frm">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <label title='nm_kabupaten'>City Name</label>
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\timesheet\backend\resources\views/trs/local/mst_kabupaten/mst_kabupaten_frm.blade.php ENDPATH**/ ?>