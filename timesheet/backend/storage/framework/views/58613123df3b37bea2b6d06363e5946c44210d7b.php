                    ...
                    <div ng-show="f.tab=='list'">
                        <div class="input-group">
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-primary btn-sm"><i class="fa fa fa-print"></i></button>
