...
<?php $__env->startSection('content'); ?>
                ...
                <form action="#" name="frm" id="frm">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="text" ng-model="h.sender" id="h_sender" class="form-control input-sm" maxlength=""
                                readonly>
                            ...
                            <input type="text" ng-model="h.server" id="h_server" class="form-control input-sm" maxlength=""
                                readonly>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <label title='ph'>PH</label>
                            <input type="text" ng-model="h.rel_d1[0].ph" id="h_ph" class="form-control input-sm"
                                maxlength="" readonly>
                            <label title='cod'>COD</label>
                            <input type="text" ng-model="h.rel_d1[0].cod" id="h_cod" class="form-control input-sm"
                                maxlength="" readonly>
                            <label title='tss'>TSS</label>
                            <input type="text" ng-model="h.rel_d1[0].tss" id="h_tss" class="form-control input-sm"
                                maxlength="5" readonly>
                        </div>
                        <div class="col-sm-4">
                            <label title='nh3n'>NH3N</label>
                            <input type="text" ng-model="h.rel_d1[0].nh3n" id="h_nh3n" class="form-control input-sm"
                                maxlength="" readonly>
                            <label title='debit'>Debit</label>
                            <input type="text" ng-model="h.rel_d1[0].debit" id="h_debit" class="form-control input-sm"
                                maxlength="" readonly>
                            <label title='devicetemp'>Temperatur Device</label>
                            <input type="text" ng-model="h.rel_d1[0].devicetemp" id="h_devicetemp"
                                class="form-control input-sm" maxlength="" readonly>
                        </div>
                        <div class="col-sm-4">
                            <label title='vcc'>VCC</label>
                            <input type="text" ng-model="h.rel_d1[0].vcc" id="h_vcc" class="form-control input-sm"
                                maxlength="" readonly>
                            <label title='battery'>Battery</label>
                            <input type="text" ng-model="h.rel_d1[0].battery" id="h_battery" class="form-control input-sm"
                                maxlength="" readonly>
                            <label title='rainfall'>Rainfall</label>
                            <input type="text" ng-model="h.rel_d1[0].rainfall" id="h_rainfall" class="form-control input-sm"
                                maxlength="" readonly>
                        </div>
                    </div>
                </form>
    ...
    <script>
        app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope,
            ...
            $scope.oSearch2 = function() {
                SfService.httpGet("trs_local_trs_raw_list2", {
                    plant: $scope.f.plant
                }, function(jdata) {
                    $scope.raw2 = jdata.data.raw2;
                });
            }
...
<?php echo $__env->make('layouts.coloradmin_minified', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\psda\psda2\backend\resources\views/trs/local/trs_raw/trs_raw_frm.blade.php ENDPATH**/ ?>