<!-- ------------------------------------------------------------------------------- -->
<?php $__env->startSection('title'); ?>District <?php $__env->stopSection(); ?>
<!-- ------------------------------------------------------------------------------- -->
                ...
                <div id="div1" class="table-responsive">
                    <table ng-table="tableList" show-filter="false" class="table table-condensed table-hover"
                        ...
                        <tr ng-repeat="v in $data">
                            <td style="padding:6px;" title="'District'" filter="{kd_kecamatan: 'text'}" sortable="">
                                {{ v . kd_kecamatan }}</td>
                            ...
                            <td style="padding:6px;" title="'City'" filter="{nm_kabupaten: 'text'}" sortable="">
                                {{ v . nm_kabupaten }}</td>
                            <td style="padding:6px;" title="'District Name'" filter="{nm_kecamatan: 'text'}" sortable="">
                                {{ v . nm_kecamatan }}</td>
                        </tr>
                    </table>
                </div>
            ...
            <div ng-show="f.tab=='frm'">
                <form action="#" name="frm" id="frm">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <label title='nm_kecamatan'>District Name</label>
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kalsel\psda\admin\backend\resources\views/trs/local/mst_kecamatan/mst_kecamatan_frm.blade.php ENDPATH**/ ?>