<!-- ------------------------------------------------------------------------------- -->
<?php $__env->startSection('title'); ?>Data Kabupaten <?php $__env->stopSection(); ?>
<!-- ------------------------------------------------------------------------------- -->
...
<?php $__env->startSection('content'); ?>
                ...
                <div class="row">
                    <div class="pull-right">
                        <div ng-show="f.tab=='list'">
                            <?php $__env->startComponent('layouts.common.coloradmin.guide', ['tag' => 'trs_local_mst_kabupaten']); ?>
                ...
                <div id="div1" class="table-responsive">
                    <table ng-table="tableList" show-filter="false" class="table table-condensed table-hover"
                        ...
                        <tr ng-repeat="v in $data">
                            <td title="'Kode Kabupaten'" filter="{kd_kabupaten: 'text'}" sortable="'kd_kabupaten'">
                                {{ v . kd_kabupaten }}</td>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <input type="text" ng-model="h.kd_kabupaten" id="h_kd_kabupaten" class="form-control input-sm"
                                maxlength="4" ng-readonly="f.crud!='c'  ">
                        </div>
                        <div class="col-sm-4">
                            <label title='kd_provinsi'>Kd Provinsi</label>
                            <input type="text" ng-model="h.kd_provinsi" id="h_kd_provinsi" class="form-control input-sm"
                                maxlength="2">
                        </div>
                        <div class="col-sm-4">
                            <label title='nm_kabupaten'>Nm Provinsi</label>
    ...
    <script>
        app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope, $http,
            ...
            SfService.setUrl("<?php echo e(url('trs_local_mst_kabupaten')); ?>");
            $scope.f = {
                crud: 'c',
                tab: 'list',
                trash: 0,
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\psda\psda2\backend\resources\views/trs/local/mst_kabupaten/mst_kabupaten_frm.blade.php ENDPATH**/ ?>