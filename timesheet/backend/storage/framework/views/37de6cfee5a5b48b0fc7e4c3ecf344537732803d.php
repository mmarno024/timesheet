                ...
                <form action="#" name="frm" id="frm">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <label>Parent</label>
                            <div class="input-group">
                                <input type="text" ng-model="h.parent" id="h_parent" class="form-control input-sm" readonly
                                    maxlength="">
                                <div class="input-group-btn">
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/admin/backend/resources/views/sys/symenu/symenu_frm.blade.php ENDPATH**/ ?>