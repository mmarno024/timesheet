                ...
                <div id="div1" class="table-responsive">
                    <table ng-table="tableList" show-filter="false" class="table table-condensed table-hover"
                        ...
                        <tr ng-repeat="v in $data" class="pointer" ng-click="oShow(v.kd_hardware)">
                            ...
                            <td style="padding:6px;" title="'Kode Hardware'" filter="{kd_hardware: 'text'}" sortable="">
                                {{ v . kd_hardware }}</td>
                            <td style="padding:6px;" title="'UID'" filter="{uid: 'text'}" sortable="">
                                {{ v . uid }}</td>
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\webmon\monitoring\webadm\backend\resources\views/trs/local/mst_hardware/mst_hardware_frm.blade.php ENDPATH**/ ?>