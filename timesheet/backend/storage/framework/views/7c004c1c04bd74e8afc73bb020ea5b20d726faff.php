...
<?php $__env->startSection('content'); ?>
    ...
    <script>
        app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', function($scope, $http, NgTableParams,
            ...
            $scope.audit = {};
            $scope.f.submenu = [
                ['syuser-syplant', 'User vs Project', 0, 'user', 'syuser', 'syplant'],
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kalsel\psda\admin\backend\resources\views/sys/sylink/sylink_frm.blade.php ENDPATH**/ ?>