                    ...
                    <tr>
                        <td rowspan="2">
                            <a href="<?php echo e(url('home')); ?>">
                                <img
                                    src="http://localhost/tatonas/webmon/monitoring/wadm/p/libftp/{{ cek_plant . image != null ? cek_plant . image : 'uploads/sys_syplant/default_logo.png' }}"></img>
                            </a>
                        </td>
                        <td rowspan="2">&nbsp;</td>
...
<?php /**PATH C:\xampp\htdocs\tatonas\webmon\monitoring\wadm\backend\resources\views/layouts/common/coloradmin/nav_top.blade.php ENDPATH**/ ?>