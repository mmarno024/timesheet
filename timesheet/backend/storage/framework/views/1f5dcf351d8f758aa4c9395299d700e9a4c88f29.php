...
<?php $__env->startSection('content'); ?>
            ...
            <div class="m-b-5 form-inline">
                <div class="pull-right">
                    <div ng-show="f.tab=='list'">
                        <?php $__env->startComponent('layouts.common.coloradmin.guide', ['tag' => 'trs_local_ms_rumus_inflow']); ?> <?php echo $__env->renderComponent(); ?>
                    ...
                    <div ng-show="f.tab=='frm'">
                        ...
                        <span ng-if="f.crud!='c'"> <?php $__env->startComponent('layouts.common.coloradmin.chat', ['route' =>
                            'trs_local_ms_rumus_inflow', 'id' => 'h.kd_ri']); ?> <?php echo $__env->renderComponent(); ?> </span>
                    </div>
                </div>
                ...
                <div id="div1" class="table-responsive">
                    <table ng-table="tableList" show-filter="false" class="table table-condensed table-hover"
                        ...
                        <tr ng-repeat="v in $data" class="pointer" ng-click="oShow(v.kd_ri)">
                            ...
                            <td title="'Angka 1'" filter="{angka1: 'text'}" sortable="'angka1'">{{ v . angka1 }}</td>
                            <td title="'Angka 2'" filter="{angka2: 'text'}" sortable="'angka2'">{{ v . angka2 }}</td>
                            <td title="'Angka 3'" filter="{angka3: 'text'}" sortable="'angka3'">{{ v . angka3 }}</td>
                ...
                <form action="#" name="frm" id="frm">
                    <div class="row">
                        <div class="col-sm-3">
                            ...
                            <input type="text" ng-model="h.kd_ri" id="h_kd_ri" class="form-control input-sm" maxlength="25">
                        </div>
                        <div class="col-sm-3">
                    ...
                    <div class="row m-t-10 m-b-10 m-l-2">
                        <div class="col-sm-6 bg-blue-lighter p-10">
                            <span class="text-white text-bold">Contoh Rumus :</span>
                            <p></p>
                            
                            <span class="text-white text-bold">Q = Angka 1 (h)<sup>Pangkat</sup> - Angka 2(h) +
                                Angka 3</span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-3">
                            <label title='angka1'>Angka 1</label>
                            <input type="number" ng-model="h.angka1" id="h_angka1" class="form-control input-sm"
                                maxlength="">
                        </div>
                        <div class="col-sm-3">
                            <label title='angka2'>Angka 2</label>
                            <input type="number" ng-model="h.angka2" id="h_angka2" class="form-control input-sm"
                                maxlength="">
                        </div>
                        <div class="col-sm-3">
                            <label title='angka3'>Angka 3</label>
                    ...
                    <div class="row m-t-10 m-b-10 m-l-2">
                        <div class="col-sm-6 bg-green-lighter p-10">
                            <span class="text-white text-bold">Hasil Contoh Rumus :</span>
                            <p></p>
                            <span class="text-white text-bold">Q = {{ h . angka1 }} (h)<sup>{{ h . pangkat }}</sup> -
                                {{ h . angka2 }}(h) +
                                {{ h . angka3 }}</span>
                        </div>
                    </div>
    ...
    <script>
        app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope, $http,
            ...
            SfService.setUrl("<?php echo e(url('trs_local_ms_rumus_inflow')); ?>");
            $scope.f = {
                crud: 'c',
                tab: 'list',
                trash: 0,
            ...
            var uploader = $scope.uploader = new FileUploader({
                ...
                onBeforeUploadItem: function(item) {
                    ...
                    item.formData = [{
                        id: $scope.h.kd_ri,
                        path: 'trs_local_ms_rumus_inflow',
                        s: 'i',
            ...
            $scope.oGallery = function() {
                SfGetMediaList('trs_local_ms_rumus_inflow/' + $scope.h.kd_ri, function(jdata) {
                    $scope.m = jdata.files;
                    $scope.$apply();
                });
            }
            ...
            $scope.oLog = function() {
                SfLog('trs_local_ms_rumus_inflow', $scope.h.kd_ri);
            }
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\webmon\backend\resources\views/trs/local/ms_rumus_inflow/ms_rumus_inflow_frm.blade.php ENDPATH**/ ?>