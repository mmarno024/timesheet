                        ...
                        <div ng-if="f.plant=='002'" class="col-lg-2 col-md-3 col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" ng-value="q.plantx + ' - ' + q.plantnamex"
                                    class="form-control input-sm" placeholder="Choose project ...">
                                <div class="input-group-btn">
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/admin/backend/resources/views/trs/local/trs_raw/trs_raw_frm.blade.php ENDPATH**/ ?>