                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2">
                            ...
                            <input type="date" class="form-control input-sm" ng-model="f.date1">
                        </div>
                        <div class="col-sm-2">
                            <label>Sampai dengan</label>
                            <input type="date" class="form-control input-sm" ng-model="f.date2">
                        </div>
                        <div class="col-sm-2">
                            <label>Logger</label>
        ...
        app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope,
            ...
            $scope.oImg = function() {
                SfService.httpGet(SfService.getUrl("_list"), {
                    ...
                    date1: moment($scope.f.date1).format(
                        'YYYY-MM-DD 00:00:01'),
                    date2: moment($scope.f.date2).format(
                        'YYYY-MM-DD 23:59:59'),
                }, function(jdata) {
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\monitoring\a_data\monitoring_back\backend\resources\views/trs/local/trs_img/trs_img_frm.blade.php ENDPATH**/ ?>