                ...
                <div id="div1" class="table-responsive">
                    <table ng-table="tableList" show-filter="false" class="table table-condensed table-hover"
                        ...
                        <tr ng-repeat="v in $data" class="pointer" ng-click="oShow(v.accessid)">
                            <td title="'Accessid'" filter="{accessid: 'text'}" sortable="'accessid'">{{ v . accessid }}
                            </td>
                            <td title="'Accessname'" filter="{accessname: 'text'}" sortable="'accessname'">
                                {{ v . accessname }}</td>
                            <td title="'Accessgroup'" filter="{accessgroup: 'text'}" sortable="'accessgroup'">
                                {{ v . accessgroup }}</td>
                            <td title="'Location'" filter="{location: 'text'}" sortable="'location'">{{ v . location }}
                            </td>
                ...
                <form action="#" name="frm" id="frm">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <input type="text" ng-model="h.accessid" id="h_accessid" class="form-control input-sm" required
                                maxlength="30" ng-readonly="f.crud!='c'">
                            <label>Accessname</label>
                            <input type="text" ng-model="h.accessname" id="h_accessname" class="form-control input-sm"
                                required maxlength="70">
                        </div>
                        <div class="col-sm-4">
                            <label>Accessgroup</label>
                            <select ng-model="h.accessgroup" id="h_accessgroup" class="form-control input-sm" required>
                                <option ng-repeat="v in [['user','User'],['group','Group']]" ng-value="v[0]">
                                    {{ v[1] }}</option>
                            </select>
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/admin/backend/resources/views/sys/syaccess/syaccess_frm.blade.php ENDPATH**/ ?>