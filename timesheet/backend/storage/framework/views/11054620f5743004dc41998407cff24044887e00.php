<!-- ------------------------------------------------------------------------------- -->
<?php $__env->startSection('title'); ?>Checklist Type List <?php $__env->stopSection(); ?>
<!-- ------------------------------------------------------------------------------- -->
...
<?php $__env->startSection('content'); ?>
    ...
    <script>
        app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope, $http,
            ...
            SfService.setUrl("<?php echo e(url('trs_local_mst_checklist_type')); ?>");
            $scope.f = {
                crud: 'c',
                tab: 'list',
                trash: 0,
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\timesheet\backend\resources\views/trs/local/mst_checklist_type/mst_checklist_type_frm.blade.php ENDPATH**/ ?>