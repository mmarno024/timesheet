...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="<?php echo e(url('coloradmin')); ?>/assets/img/icon-balon.png"/>
...
<body data-spy="scroll" data-target="#header-navbar" data-offset="51">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="header-navbar">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="<?php echo e(\Auth::check()?url('home'):url('login')); ?>" ><?php echo e(\Auth::check()?'ADMIN PAGE':'SIGN IN'); ?></a></li>
                    </ul>
                </div>
                <!-- end navbar-collapse -->
            </div>
        ...
        <div id="footer" class="footer">
            <div class="container">
                ...
                <p>
                    ...
                    <?php echo e(\App\Sf::getParsys('APP_DESC')); ?>. Created by <a href="mailto:it.wp@dsngroup.co.id">IT DSNWP</a>
                </p>
                <p class="social-list">
	...
	<!-- ================== BEGIN BASE JS ================== -->
	<script src="<?php echo e(url('colorparalax')); ?>/assets/plugins/jquery/jquery-1.9.1.min.js"></script>
	<script src="<?php echo e(url('colorparalax')); ?>/assets/plugins/jquery/jquery-migrate-1.1.0.min.js"></script>
...
<?php /**PATH C:\xampp\htdocs\tatonas\besai\backend\resources\views/layouts/colorparalax.blade.php ENDPATH**/ ?>