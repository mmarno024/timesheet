        ...
        <div class="panel-body">
            ...
            <div ng-show="f.tab=='frm'">
                <form action="#" name="frm" id="frm">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <h3 class="text-success">Nilai Sensor</h3>
                            <p>
                                <span ng-repeat="v1 in h.rel_d1">
                                    <button type="button"
...
<?php echo $__env->make('layouts.coloradmin_minified', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\psda\psda\backend\resources\views/trs/local/trs_raw/trs_raw_frm.blade.php ENDPATH**/ ?>