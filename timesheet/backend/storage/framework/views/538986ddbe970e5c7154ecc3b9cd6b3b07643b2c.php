                    ...
                    <div class="panel-body table-responsive">
                        <table class="table table-condensed table-striped table-hover">
                            ...
                            <tr class="pointer" ng-click="oDisp('<?php echo e($v->parid); ?>','<?php echo e($v->parname); ?>')">
                                <td class="p-l-20">
                                    <?php echo e($v->isplant == 1 ? \App\Sf::getJson($v->parvalue, Session::get('plant')) : $v->parvalue); ?>
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\timesheet\backend\resources\views/sys/syparsys/syparsys_frm.blade.php ENDPATH**/ ?>