...
<link href="<?php echo e(url('coloradmin')); ?>/assets/css/style_all_prov.css" rel="stylesheet" />
    ...
    <div ng-repeat="(k,v) in data_hardware" class="col-lg-4 col-12 m-0 p-2">
        <div class="col-lg-12 col-12 m-0 p-2 bg-white" style="border-radius: 5px;">
            <div class="col-lg-12 col-12 m-0 p-r-0 p-b-0 p-l-0 p-t-2" style="">
                <div class="col-lg-11 col-md-11 col-sm-11 m-0 p-0" style="float:left">
                    <span ng-if="v.detail['waterlevel'].status == 'normal' && v.detail_ews[0].ews_sirine == 0 && v.detail_ews[0].ews_sirine_reply == 0" class="text-primary text-bold m-l-5">POS WATER LEVEL - {{ v . pos_name }}</span>
                    <span ng-if="v.detail['waterlevel'].status == 'normal' && v.detail_ews[0].ews_sirine == 1 && v.detail_ews[0].ews_sirine_reply == 0" class="text-primary text-bold m-l-5">POS WATER LEVEL - {{ v . pos_name }}</span>
                    <span ng-if="v.detail['waterlevel'].status == 'normal' && v.detail_ews[0].ews_sirine == 0 && v.detail_ews[0].ews_sirine_reply == 1" class="text-bold m-l-5 blink_blue">POS WATER LEVEL - {{ v . pos_name }}</span>
                    <span ng-if="v.detail['waterlevel'].status != 'normal' && v.detail['waterlevel'].alarm_status == 3" style="-webkit-text-stroke: 0.1px black" class="text-bold m-l-5 blink_yellow">POS WATER LEVEL - {{ v . pos_name }}</span>
                    <span ng-if="v.detail['waterlevel'].status != 'normal' && v.detail['waterlevel'].alarm_status == 4" class="text-bold m-l-5 blink_orange">POS WATER LEVEL - {{ v . pos_name }}</span>
                    <span ng-if="v.detail['waterlevel'].status != 'normal' && (v.detail['waterlevel'].alarm_status >= 5 && v.detail['waterlevel'].alarm_status < 8)" class="text-bold m-l-5 blink_red">POS WATER LEVEL - {{ v . pos_name }}</span>
                </div>
                    ...
                    <div class="image gallery-group-1 m-0" style="width: 100%;padding:0;border-radius: 5px">
                        <div class="image-inner">
                            <a ng-if="v.device_img == NULL" href="<?php echo e(url('coloradmin')); ?>/assets/img/broken_image.png" data-lightbox="gallery-group-1">
                                <img ng-if="v.device_img == NULL" src="<?php echo e(url('coloradmin')); ?>/assets/img/broken_image.png" alt="" style="border-radius:5px;" />
                            </a>
...
<?php echo $__env->make('layouts.colorreport_blank', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kalsel\psda\admin\backend\resources\views/trs/local/trs_view/trs_view_all_prov_frm.blade.php ENDPATH**/ ?>