    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <div class="m-b-5 form-inline">
                ...
                <button ng-show="f.plant=='002'" type="button" class="btn btn-sm btn-inverse" ng-click="oNew()"
                    ng-attr-title="Buat Baru" ng-show="f.tab=='list' && f.trash!=1"><i class="fa fa-plus"></i> New</button>
                <button ng-show="f.plant!='002'" type="button" class="btn btn-sm btn-default" ng-attr-title="Buat Baru"
                    ...
                    <table ng-table="tableList" show-filter="false" class="table table-condensed table-hover"
                        ...
                        <tr ng-repeat="(k,v) in $data" class="pointer" ng-click="oShow(v.kd_sensor)">
                            ...
                            <td style="padding:6px;" title="'Satuan'" filter="{satuan: 'text'}" sortable="">
                                {{ v . satuan }}</td>
                            <td style="padding:6px;" title="'Akumulasi'" filter="{cumulative: 'text'}" sortable="">
                                {{ v . cumulative }}</td>
            ...
            <div ng-show="f.tab=='frm'">
                <form action="#" name="frm" id="frm">
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <label title='cumulative'>Akumulasi</label>
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\webmon\monitoring\wadm\backend\resources\views/trs/local/mst_sensor/mst_sensor_frm.blade.php ENDPATH**/ ?>