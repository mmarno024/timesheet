<!-- ------------------------------------------------------------------------------- -->
<?php $__env->startSection('title'); ?>Master Kabupaten <?php $__env->stopSection(); ?>
<!-- ------------------------------------------------------------------------------- -->
...
<?php $__env->startSection('content'); ?>
            ...
            <div class="m-b-5 form-inline">
                <div class="pull-right">
                    <div ng-show="f.tab=='list'">
                        <?php $__env->startComponent('layouts.common.coloradmin.guide', ['tag' => 'trs_local_ms_kabupaten']); ?> <?php echo $__env->renderComponent(); ?>
                    ...
                    <div ng-show="f.tab=='frm'">
                        ...
                        <span ng-if="f.crud!='c'"> <?php $__env->startComponent('layouts.common.coloradmin.chat', ['route' =>
                            'trs_local_ms_kabupaten', 'id' => 'h.rowid']); ?> <?php echo $__env->renderComponent(); ?> </span>
                    </div>
                </div>
                ...
                <div id="div1" class="table-responsive">
                    <table ng-table="tableList" show-filter="false" class="table table-condensed table-hover"
                        ...
                        <tr ng-repeat="v in $data" class="pointer" ng-click="oShow(v.rowid)">
                            ...
                            <td title="'Kd Propinsi'" filter="{kd_propinsi: 'text'}" sortable="'kd_propinsi'">
                                {{ v . kd_propinsi }}</td>
                            <td title="'Kd Kabupaten'" filter="{kd_kabupaten: 'text'}" sortable="'kd_kabupaten'">
                                {{ v . kd_kabupaten }}</td>
                            <td title="'Nm Kabupaten'" filter="{nm_kabupaten: 'text'}" sortable="'nm_kabupaten'">
                                {{ v . nm_kabupaten }}</td>
                        </tr>
                    </table>
                </div>
                ...
                <form action="#" name="frm" id="frm">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" ng-value="h.kd_propinsi+' | '+h.nm_propinsi" id="h_kd_propinsi"
                                    class="form-control input-sm" readonly maxlength="15" ng-readonly="true">
                                <div class="input-group-btn">
                                    <button class="btn btn-success btn-sm" type="button"
                                        ng-click="oLookup('kd_propinsi')"><i class="fa fa-search"></i></button>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            ...
                            <input type="text" ng-model="h.kd_kabupaten" id="h_kd_kabupaten" class="form-control input-sm"
                                maxlength="">
                            <label title='nm_kabupaten'>Nm Kabupaten</label>
                            <input type="text" ng-model="h.nm_kabupaten" id="h_nm_kabupaten" class="form-control input-sm"
                                maxlength="50">
                        </div>
                    </div>
    ...
    <script>
        app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope, $http,
            ...
            SfService.setUrl("<?php echo e(url('trs_local_ms_kabupaten')); ?>");
            $scope.f = {
                crud: 'c',
                tab: 'list',
                trash: 0,
            ...
            $scope.oGallery = function() {
                SfGetMediaList('trs_local_ms_kabupaten/' + $scope.h.rowid, function(jdata) {
                    $scope.m = jdata.files;
                    $scope.$apply();
                });
            }
            ...
            $scope.oLookup = function(id, selector, obj) {
                switch (id) {
                    case 'kd_propinsi':
                        ...
                        break;
                        // case 'kd_propinsi':
                        //     SfLookup("<?php echo e(url('trs_local_ms_propinsi_lookup')); ?>?plant=" + $scope.f.plant,
                        //         function(id, name, jsondata) {
                        //             $scope.h.kd_propinsi = jsondata.kd_propinsi;
                        //             $scope.h.nm_propinsi = jsondata.nm_propinsi;
                        //             $scope.$apply();
                        //         });
                        //     break;
                    default:
            ...
            $scope.oLog = function() {
                SfLog('trs_local_ms_kabupaten', $scope.h.rowid);
            }
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\webmon\backend\resources\views/trs/local/ms_kabupaten/ms_kabupaten_frm.blade.php ENDPATH**/ ?>