                    ...
                    <tr>
                        <td rowspan="2">
                            <a href="<?php echo e(url('home')); ?>">
                                <img
                                    src="http://localhost/monitoring/a_data/monitoring_back/p/libftp/{{ cek_plant . image != null ? cek_plant . image : 'uploads/sys_syplant/default_logo.png'}}"></img>
                            </a>
                        </td>
                        <td rowspan="2">&nbsp;</td>
...
<script>
    app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope, $http,
        ...
        $scope.h = {};
        $scope.userid = "<?php echo e(Auth::user()->userid); ?>";
        $scope.plant = "<?php echo e(Session::get('plant')); ?>";
...
<?php /**PATH C:\xampp\htdocs\monitoring\a_data\monitoring_back\backend\resources\views/layouts/common/coloradmin/nav_top.blade.php ENDPATH**/ ?>