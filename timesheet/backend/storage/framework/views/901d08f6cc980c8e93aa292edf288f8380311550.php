                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-3">
                            ...
                            <select ng-model="q.vqmode" class="form-control input-sm" style="background:aquamarine">
                                <option ng-repeat="vq in ['device','server','user']">{{ vq }}</option>
                            </select>
                        </div>
                        <div class="col-lg-2 col-md-3 col-sm-3">
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kalsel\psda\admin\backend\resources\views/trs/local/trs_log_activity_ews/trs_log_activity_ews_frm.blade.php ENDPATH**/ ?>