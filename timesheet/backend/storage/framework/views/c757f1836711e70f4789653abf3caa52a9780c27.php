<!-- ------------------------------------------------------------------------------- -->
<?php $__env->startSection('title'); ?>Master Analisa <?php $__env->stopSection(); ?>
<!-- ------------------------------------------------------------------------------- -->
        ...
        <div class="m-b-5 form-inline">
            <div class="pull-right">
                <div ng-show="f.tab=='list'">
                    <?php $__env->startComponent('layouts.common.coloradmin.guide',['tag'=>'trs_local_ms_analisa']); ?> <?php echo $__env->renderComponent(); ?>
                ...
                <div ng-show="f.tab=='frm'">
                    ...
                    <span ng-if="f.crud!='c'"> <?php $__env->startComponent('layouts.common.coloradmin.chat',['route'=>'trs_local_ms_analisa','id'=>'h.rowid']); ?>  <?php echo $__env->renderComponent(); ?> </span>
                </div>
            </div>
            ...
            <div id="div1" class="table-responsive">
                <table ng-table="tableList" show-filter="false" class="table table-condensed table-hover" style="white-space: nowrap;">
                    <tr ng-repeat="v in $data" class="pointer" ng-click="oShow(v.rowid)">
                        ...
                        <td title="'Nm Analisa'" filter="{nm_analisa: 'text'}" sortable="'nm_analisa'">{{v.nm_analisa}}</td>
            ...
            <form action="#" name="frm" id="frm">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <label title='nm_analisa'>Nm Analisa</label>
                        <input type="text" ng-model="h.nm_analisa" id="h_nm_analisa" class="form-control input-sm"    maxlength="30"  >
                    </div>
                    <div class="col-sm-4">
...
app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope, $http, NgTableParams, SfService, FileUploader) {
    SfService.setUrl("<?php echo e(url('trs_local_ms_analisa')); ?>");
    ...
    $scope.m = [];
     ...
     var uploader = $scope.uploader = new FileUploader({
        ...
        onBeforeUploadItem: function(item) {
            ...
            item.formData = [{ id: $scope.h.rowid, path: 'trs_local_ms_analisa', s: 'i', userid: $scope.f.userid, plant: $scope.f.plant }];
        },
    ...
    $scope.oGallery = function() {
        SfGetMediaList('trs_local_ms_analisa/' + $scope.h.rowid, function(jdata) {
            $scope.m = jdata.files;
            $scope.$apply();
        });
    }
    ...
    $scope.oLookup = function(id, selector, obj) {
     ...
     $scope.oLog=function(){
        SfLog('trs_local_ms_analisa',$scope.h.rowid);
    }
