            ...
            <div class="m-b-5 form-inline">
                ...
                <div class="row" ng-show="f.tab=='list'">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div ng-show="f.plant=='002'" class="col-lg-2 col-md-3 col-sm-4">
                            <label>Jenis Logger</label>
                            <div class="input-group">
                                <input type="text" ng-value="q.nm_logger" class="form-control input-sm"
                                    placeholder="Choose logger ..." readonly>
                                <div class="input-group-btn">
                                    <button class="btn btn-primary btn-sm" type="button"
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" ng-value="q.kd_hardware" class="form-control input-sm"
                ...
                <div id="div1" class="table-responsive">
                    <table ng-table="tableList" show-filter="false" class="table table-condensed table-hover"
                        ...
                        <tr ng-repeat="v in $data" class="pointer" ng-click="oShow(v.id)">
                            <td style="padding:5px;" title="'Waktu terima'" filter="{created_at: 'text'}" sortable="''">
                                {{ v.created_at }}</td>
                            <td style="padding:5px;" title="'Waktu Aktual'" filter="{tlocal: 'text'}" sortable="''">
                                {{ v.tlocal }}</td>
                            ...
                            <td style="padding:5px;" title="'Nilai'" filter="{location: 'text'}" sortable="">
                                ...
                                <span ng-if="v.kd_logger=='3'" ng-repeat="v1 in v.rel_d_extenso"
                                    class="label label-inverse m-r-5" style="font-size: 10px;">
                                    {{ v1.kd_sensor }} : {{ v1.value }}
                                </span>
                                <span ng-if="v.kd_logger=='4'" ng-repeat="v1 in v.rel_d_suhu"
                                    class="label label-inverse m-r-5" style="font-size: 10px;">
                                    {{ v1.kd_sensor }} : {{ v1.value }}
                                </span>
                ...
                <form action="#" name="frm" id="frm">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <label title='tlocal'>Waktu Lokal</label>
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" ng-model="h.rel_plant.plantname" id="h_rel_plant_plantname" class="form-control input-sm" readonly>
                        </div>
                        <div class="col-sm-12">
                    ...
                    <div class="row" ng-show="h.kd_logger=='3'">
                        <div class="col-sm-3">
                            <label title='simpan_data_pertama'>Simpan data pertama</label>
                            <input type="text" ng-model="h.rel_d_extenso[0].simpan_data_pertama" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='kejadian_alarm_keamanan'>Alarm keamanan</label>
                            <input type="text" ng-model="h.rel_d_extenso[0].kejadian_alarm_keamanan" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='kejadian_tindih_memory'>Tindih memory</label>
                            <input type="text" ng-model="h.rel_d_extenso[0].kejadian_tindih_memory" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='status_alarm'>Status alarm</label>
                            <input type="text" ng-model="h.rel_d_extenso[0].status_alarm" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='nilai_alarm4'>Nilai alarm 4</label>
                            <input type="text" ng-model="h.rel_d_extenso[0].nilai_alarm4" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='sensor_buka_pintu'>Sensor buka pintu</label>
                            <input type="text" ng-model="h.rel_d_extenso[0].sensor_buka_pintu" id="h_sender"
                                class="form-control input-sm" readonly>
                        </div>
                        <div class="col-sm-3">
                            <label title='simpan_data_terakhir'>Simpan data terakhir</label>
                            <input type="text" ng-model="h.rel_d_extenso[0].simpan_data_terakhir" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='logger_aktual'>Logger aktual</label>
                            <input type="text" ng-model="h.rel_d_extenso[0].logger_aktual" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='data_tersimpan'>Data tersimpan</label>
                            <input type="text" ng-model="h.rel_d_extenso[0].data_tersimpan" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='nilai_alarm1'>Nilai alarm 1</label>
                            <input type="text" ng-model="h.rel_d_extenso[0].nilai_alarm1" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='nilai_alarm_rendah'>Nilai alarm rendah</label>
                            <input type="text" ng-model="h.rel_d_extenso[0].nilai_alarm_rendah" id="h_sender"
                                class="form-control input-sm" readonly>
                        </div>
                        <div class="col-sm-3">
                            <label title='pengambilan_data'>Pengambilan data</label>
                            <input type="text" ng-model="h.rel_d_extenso[0].pengambilan_data" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='sms_map_server'>Sms map server</label>
                            <input type="text" ng-model="h.rel_d_extenso[0].sms_map_server" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='interval_waktu'>Interval waktu</label>
                            <input type="text" ng-model="h.rel_d_extenso[0].interval_waktu" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='nilai_alarm2'>Nilai alarm 2</label>
                            <input type="text" ng-model="h.rel_d_extenso[0].nilai_alarm2" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='tinggi_level_awal'>Tinggi level awal</label>
                            <input type="text" ng-model="h.rel_d_extenso[0].tinggi_level_awal" id="h_sender"
                                class="form-control input-sm" readonly>
                        </div>
                        <div class="col-sm-3">
                            <label title='kejadian_alarm_level'>Alarm level</label>
                            <input type="text" ng-model="h.rel_d_extenso[0].kejadian_alarm_level" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='data_logger_terpakai'>Data terpakai</label>
                            <input type="text" ng-model="h.rel_d_extenso[0].data_logger_terpakai" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='baca_sensor_level'>Baca sensor level</label>
                            <input type="text" ng-model="h.rel_d_extenso[0].baca_sensor_level" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='nilai_alarm3'>Nilai alarm 3</label>
                            <input type="text" ng-model="h.rel_d_extenso[0].nilai_alarm3" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='sampel_baca_sensor'>Sample baca sensor</label>
                            <input type="text" ng-model="h.rel_d_extenso[0].sampel_baca_sensor" id="h_sender"
                                class="form-control input-sm" readonly>
                        </div>
                    </div>

                    <div class="row" ng-show="h.kd_logger=='4'">
                        <div class="col-sm-3">
                            <label title='simpan_data_pertama'>Simpan data pertama</label>
                            <input type="text" ng-model="h.rel_d_suhu[0].simpan_data_pertama" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='kejadian_alarm_keamanan'>Alarm keamanan</label>
                            <input type="text" ng-model="h.rel_d_suhu[0].kejadian_alarm_keamanan" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='kejadian_tindih_memory'>Tindih memory</label>
                            <input type="text" ng-model="h.rel_d_suhu[0].kejadian_tindih_memory" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='status_alarm'>Status alarm</label>
                            <input type="text" ng-model="h.rel_d_suhu[0].status_alarm" id="h_sender"
                                class="form-control input-sm" readonly>
                        </div>
                        <div class="col-sm-3">
                            <label title='simpan_data_terakhir'>Simpan data terakhir</label>
                            <input type="text" ng-model="h.rel_d_suhu[0].simpan_data_terakhir" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='logger_aktual'>Logger aktual</label>
                            <input type="text" ng-model="h.rel_d_suhu[0].logger_aktual" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='data_tersimpan'>Data tersimpan</label>
                            <input type="text" ng-model="h.rel_d_suhu[0].data_tersimpan" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='nilai_alarm_hujan_harian'>Nilai alarm hujan harian</label>
                            <input type="text" ng-model="h.rel_d_suhu[0].nilai_alarm_hujan_harian" id="h_sender"
                                class="form-control input-sm" readonly>
                        </div>
                        <div class="col-sm-3">
                            <label title='pengambilan_data'>Pengambilan data</label>
                            <input type="text" ng-model="h.rel_d_suhu[0].pengambilan_data" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='sms_map_server'>Sms map server</label>
                            <input type="text" ng-model="h.rel_d_suhu[0].sms_map_server" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='interval_waktu'>Interval waktu</label>
                            <input type="text" ng-model="h.rel_d_suhu[0].interval_waktu" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='nilai_curah_hujan'>Nilai curah hujan</label>
                            <input type="text" ng-model="h.rel_d_suhu[0].nilai_curah_hujan" id="h_sender"
                                class="form-control input-sm" readonly>
                        </div>
                        <div class="col-sm-3">
                            <label title='kejadian_alarm_level'>Alarm level</label>
                            <input type="text" ng-model="h.rel_d_suhu[0].kejadian_alarm_level" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='data_logger_terpakai'>Data terpakai</label>
                            <input type="text" ng-model="h.rel_d_suhu[0].data_logger_terpakai" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='curah_hujan_harian'>Curah hujan harian</label>
                            <input type="text" ng-model="h.rel_d_suhu[0].curah_hujan_harian" id="h_sender"
                                class="form-control input-sm" readonly>
                            <label title='sensor_buka_pintu'>Sensor buka pintu</label>
                            <input type="text" ng-model="h.rel_d_suhu[0].sensor_buka_pintu" id="h_sender"
                                class="form-control input-sm" readonly>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12">
                            ...
                            <p>
                                <span ng-repeat="v1 in h.rel_d_ftp">
                                    <button type="button" class="btn btn-warning m-t-5">{{ v1.rel_sensor.nm_sensor }}
                                        :
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kalsel\bpbd\admin\backend\resources\views/trs/local/trs_raw/trs_raw_frm.blade.php ENDPATH**/ ?>