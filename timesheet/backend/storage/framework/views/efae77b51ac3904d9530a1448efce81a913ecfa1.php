                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-2">
                                <label>Project</label>
                                <div class="input-group">
                                    <input type="text" ng-value="f.plant + ' - ' + f.plantname"
                            ...
                            <div class="col-sm-2">
                                <label>Logger</label>
                                <div class="input-group">
                                    <input type="text" ng-value="f.nm_logger" class="form-control input-sm m-b-5"
                    ...
                    <table ng-table="tableList" show-filter="false" class="table table-condensed table-hover"
                        ...
                        <tr ng-repeat="v in $data" class="pointer" ng-click="oShow(v.id)">
                            ...
                            <td style="padding:5px;" title="'Nilai'" filter="{location: 'text'}" sortable="">
                                <span ng-if="v.kd_logger=='1'" ng-repeat="v1 in v.rel_d_wl.baca_sensor_level"
                                    class="label label-primary m-r-5" style="font-size: 10px;">
                                    {{ v1 . kd_sensor }} : {{ v1 . data_aktual }}
                                </span>
                                <span ng-if="v.kd_logger=='2'" ng-repeat="v1 in v.rel_d_ch"
                                    class="label label-success m-r-5" style="font-size: 10px;">
                                    {{ v1 . kd_sensor }} : {{ v1 . nilai_curah_hujan }}
                                </span>
                                <span ng-if="v.kd_logger=='5'" ng-repeat="v1 in v.rel_d_img"
                                    class="label label-danger m-r-5" style="font-size: 10px;">
                                    {{ v1 . kd_sensor }} : {{ v1 . data_aktual }}
                                </span>
                ...
                <form action="#" name="frm" id="frm">
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <textarea class="form-control input-sm" ng-model="h.parameter" readonly></textarea>
                        ...
                        <div class="col-sm-12">
                            ...
                            <p>
                                <span ng-repeat="v1 in h.rel_d_ftp">
                                    <button type="button"
                                        class="btn btn-warning m-b-5">{{ v1 . rel_sensor . nm_sensor }}
                                        :
                                        {{ v1 . data_aktual }}
                    ...
                    case 'plant':
                        SfLookup("<?php echo e(url('sys_syplant_lookup')); ?>?plant=" + $scope.f.plant,
                            function(id, name, jsondata) {
                                $scope.f.plant = jsondata.plant;
                                $scope.f.plantname = jsondata.plantname;
                                $scope.$apply();
                            });
                        break;
                    case 'kd_logger':
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\monitoring\a_data\monitoring_back\backend\resources\views/trs/local/trs_raw/trs_raw_frm.blade.php ENDPATH**/ ?>