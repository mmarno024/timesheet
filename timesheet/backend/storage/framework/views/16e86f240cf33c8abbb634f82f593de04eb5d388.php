    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade in" id="tab-3">
            <div id="div1" class="table-responsive">
                <table ng-table="tableList" show-filter="false" class="table table-condensed " style="white-space: nowrap;">
                ...
                <h3>Change Password</h3>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <label>&nbsp;</label>
                            <button class="btn btn-sm btn-success btn-block" type="button" ng-click="oChangePass();">Change Password</button>
                        </div>
                    </div>
            </div>
        </div>
    ...
    $scope.oChangePass = function() {
        if (SfFormValidate('.must') == true) {
            if ($scope.x == {}) {
                ...
                SfService.httpPost(SfService.getUrl('_change_pass'), { userid: "<?php echo e($syuser->userid); ?>", x: $scope.x },
                    function(jdata) {
                        swal(jdata.data);
                    });
            }
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\besai\backend\resources\views/sys/syuser/syuser_profile.blade.php ENDPATH**/ ?>