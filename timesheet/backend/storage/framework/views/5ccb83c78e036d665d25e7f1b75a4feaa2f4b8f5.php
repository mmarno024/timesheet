                    ...
                    <tr>
                        <td rowspan="2">
                            <a href="<?php echo e(url('home')); ?>">
                                <img src="<?php echo e(url('coloradmin/assets/img/logo-small.png')); ?>"></img>
                            </a>
                        </td>
                        <td rowspan="2">&nbsp;</td>
                        <td style="font-weight:bold;color:#0059b3;font-size:17px;line-height:1;border:none">
                            <i class="fa fa-home"></i>&nbsp;
                            <?php echo e(Auth::user() != '' ? \App\Sf::getPlantname(Auth::user()->def_plant) : \App\Sf::getParsys('APP_LABEL')); ?>
...
<?php /**PATH C:\laragon\www\timesheet\backend\resources\views/layouts/common/coloradmin/nav_top.blade.php ENDPATH**/ ?>