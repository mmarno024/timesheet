            ...
            <div id="div1" class="table-responsive">
                <table ng-table="tableList" show-filter="false" class="table table-condensed table-hover" style="white-space: nowrap;">
                    <tr ng-repeat="v in $data" class="pointer" ng-click="oShow(v.id)">
                        ...
                        <td title="'User'" filter="{created_by: 'text'}" sortable="'created_by'">{{v.created_by}} - {{v.rel_created_by.username}}</td>
            ...
            <form action="#" name="frm" id="frm">
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <label>Trs</label>
                        <input type="text" ng-model="h.trs" id="h_trs" class="form-control input-sm" required readonly  maxlength="30">
                    </div>
                    <div class="col-sm-4">
                        <label>Doc No</label>
                        <input type="text" ng-model="h.doc_no" id="h_doc_no" class="form-control input-sm" required readonly  maxlength="30">
                        <label>Tag</label>
                        <input type="text" ng-model="h.tag" id="h_tag" class="form-control input-sm"  readonly  maxlength="200">
                    </div>
                    <div class="col-sm-4">
                        <label>Activity</label>
                        <textarea ng-model="h.activity" id="h_activity" class="form-control input-sm" required rows="10"></textarea>
                    </div>
                </div>
                <hr>
...
app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', function($scope, $http, NgTableParams, SfService) {
    ...
    $scope.f = { crud: 'c', tab: 'list', trash: 0 ,userid:"<?php echo e(Session::get('userid')); ?>"};
    $scope.h = {};
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\psda\psda2\backend\resources\views/sys/sylog/sylog_frm.blade.php ENDPATH**/ ?>