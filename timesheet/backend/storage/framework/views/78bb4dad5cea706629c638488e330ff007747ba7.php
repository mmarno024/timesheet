<!-- ------------------------------------------------------------------------------- -->
<?php $__env->startSection('title'); ?>Data Provinsi <?php $__env->stopSection(); ?>
<!-- ------------------------------------------------------------------------------- -->
...
<?php $__env->startSection('content'); ?>
                ...
                <div class="row">
                    <div class="pull-right">
                        <div ng-show="f.tab=='list'">
                            <?php $__env->startComponent('layouts.common.coloradmin.guide', ['tag' => 'trs_local_mst_provinsi']); ?> <?php echo $__env->renderComponent(); ?>
                ...
                <div id="div1" class="table-responsive">
                    <table ng-table="tableList" show-filter="false" class="table table-condensed table-hover"
                        ...
                        <tr ng-repeat="v in $data">
                            <td title="'Kode Provinsi'" filter="{kd_provinsi: 'text'}" sortable="'kd_provinsi'">
                                {{ v . kd_provinsi }}</td>
            ...
            <div ng-show="f.tab=='frm'">
                <form action="#" name="frm" id="frm">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <label title='nm_provinsi'>Nm Provinsi</label>
    ...
    <script>
        app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope, $http,
            ...
            SfService.setUrl("<?php echo e(url('trs_local_mst_provinsi')); ?>");
            $scope.f = {
                crud: 'c',
                tab: 'list',
                trash: 0,
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\psda\psda2\backend\resources\views/trs/local/mst_provinsi/mst_provinsi_frm.blade.php ENDPATH**/ ?>