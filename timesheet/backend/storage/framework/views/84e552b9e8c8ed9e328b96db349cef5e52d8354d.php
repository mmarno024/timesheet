                ...
                <form action="#" name="frm" id="frm">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            ...
                            <input type="text" ng-model="h.latitude" id="h_latitude" class="form-control input-sm" required>
                        </div>
                        <div class="col-sm-3">
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\webmon\monitoring\a_data\monitoring_back\backend\resources\views/sys/syplant/syplant_frm.blade.php ENDPATH**/ ?>