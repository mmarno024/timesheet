                ...
                <div id="gallery" class="col-lg-12 col-12 gallery m-0 p-5">
                    <div class="image gallery-group-1 m-0" style="width: 100%;padding:0;border-radius: 5px">
                        <div class="image-inner">
                            <a ng-if="data_hardware.device_img == NULL" href="<?php echo e(url('coloradmin')); ?>/assets/img/cctv.jpg" data-lightbox="gallery-group-1">
                                <img style="border-radius:5px;height:100%;" ng-if="data_hardware.device_img == NULL" src="<?php echo e(url('coloradmin')); ?>/assets/img/cctv.jpg" alt="" />
                            </a>
...
<?php echo $__env->make('layouts.colorreport_blank', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kalsel\kalsel_fix\admin\backend\resources\views/trs/local/trs_view/trs_view_single_prov_frm.blade.php ENDPATH**/ ?>