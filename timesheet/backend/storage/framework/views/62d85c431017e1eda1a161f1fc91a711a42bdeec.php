...
<body ng-app="sfApp" ng-controller="topCtrl" id="topCtrl">
    ...
    <div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixedxxx page-sidebar-minified ">
        <!-- begin #header -->
        <?php $__env->startComponent('layouts.common.coloradmin.nav_topx'); ?> <?php echo $__env->renderComponent(); ?>
        <!-- end #header -->
        <!-- begin #sidebar -->
...
<?php /**PATH C:\xampp\htdocs\tatonas\webmon\backend\resources\views/layouts/coloradmin_minifiedx.blade.php ENDPATH**/ ?>