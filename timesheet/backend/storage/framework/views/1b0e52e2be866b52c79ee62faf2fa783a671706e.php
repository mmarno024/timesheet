...
<head>
    ...
    <link href="<?php echo e(url('coloradmin')); ?>/assets/css/overide.css?ver=2020.11.18" rel="stylesheet" id="theme" />
    <link href="<?php echo e(url('coloradmin')); ?>/assets/plugins/tags/bootstrap-tagsinput.css" rel="stylesheet" />
    <!-- ================== END BASE CSS STYLE ================== -->
...
<body ng-app="sfApp" ng-controller="topCtrl" id="topCtrl">
    ...
    <div id="page-container" ng-controller="mainCtrl" id="mainCtrl"
        class="page-container fade page-sidebar-fixed page-header-fixedxxx">
        <!-- begin #header -->
  ...
  <![endif]-->
    ...
    <script src="<?php echo e(url('coloradmin')); ?>/assets/plugins/tags/bootstrap-tagsinput.min.js"></script>
    <script src="<?php echo e(url('coloradmin')); ?>/assets/plugins/tags/bootstrap-tagsinput-angular.min.js"></script>
    <!-- ================== END BASE JS ================== -->
    <!-- ================== BEGIN PAGE LEVEL JS ================== -->
...
<?php /**PATH C:\xampp\htdocs\monitoring\a_data\monitoring_back\backend\resources\views/layouts/coloradmin.blade.php ENDPATH**/ ?>