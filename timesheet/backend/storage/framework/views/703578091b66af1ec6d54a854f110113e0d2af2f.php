...
<body ng-app="sfApp" ng-controller="topCtrl" id="topCtrl" onkeypress="return disableCtrlKeyCombination(event);"
    ...
    <div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixedxxx">
        <!-- begin #header -->
...
<?php /**PATH C:\xampp\htdocs\tatonas\webmon\monitoring\a_data\monitoring_back\backend\resources\views/layouts/coloradmin.blade.php ENDPATH**/ ?>