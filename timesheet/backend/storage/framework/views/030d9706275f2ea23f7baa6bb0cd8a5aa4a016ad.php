                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <span ng-repeat="v2 in sensor">
                                <button type="button" class="btn btn-danger m-b-5">{{ v2 }}</button>&nbsp;
                            </span>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\psda\psda2\backend\resources\views/trs/local/mst_sensor/mst_sensor_frm.blade.php ENDPATH**/ ?>