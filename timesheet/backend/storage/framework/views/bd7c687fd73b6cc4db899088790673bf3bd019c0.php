                ...
                <div id="div1" class="table-responsive">
                    <table ng-table="tableList" show-filter="false" class="table table-condensed table-hover"
                        ...
                        <tr ng-repeat="v in $data">
                            <td style="padding:6px;" title="'Kode Desa'" filter="{kd_desa: 'text'}" sortable="">
                                {{ v . kd_desa }}
                            </td>
                            ...
                            <td style="padding:6px;" title="'Nama Kecamatan'" filter="{nm_kecamatan: 'text'}" sortable="">
                                {{ v . nm_kecamatan }}</td>
                            <td style="padding:6px;" title="'Nama Desa'" filter="{nm_desa: 'text'}" sortable="">
                                {{ v . nm_desa }}
                            </td>
                        </tr>
                    </table>
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/admin/backend/resources/views/trs/local/mst_desa/mst_desa_frm.blade.php ENDPATH**/ ?>