<!-- ------------------------------------------------------------------------------- -->
<?php $__env->startSection('title'); ?>Master Propinsi <?php $__env->stopSection(); ?>
<!-- ------------------------------------------------------------------------------- -->
        ...
        <div class="m-b-5 form-inline">
            <div class="pull-right">
                <div ng-show="f.tab=='list'">
                    <?php $__env->startComponent('layouts.common.coloradmin.guide',['tag'=>'trs_local_ms_propinsi']); ?> <?php echo $__env->renderComponent(); ?>
                ...
                <div ng-show="f.tab=='frm'">
                    ...
                    <span ng-if="f.crud!='c'"> <?php $__env->startComponent('layouts.common.coloradmin.chat',['route'=>'trs_local_ms_propinsi','id'=>'h.rowid']); ?>  <?php echo $__env->renderComponent(); ?> </span>
                </div>
            </div>
            ...
            <div id="div1" class="table-responsive">
                <table ng-table="tableList" show-filter="false" class="table table-condensed table-hover" style="white-space: nowrap;">
                    <tr ng-repeat="v in $data" class="pointer" ng-click="oShow(v.rowid)">
                        ...
                        <td title="'Nm Propinsi'" filter="{nm_propinsi: 'text'}" sortable="'nm_propinsi'">{{v.nm_propinsi}}</td>
                    </tr>
                </table>
            </div>
        </div>
        <div ng-show="f.tab=='frm'">
            <form action="#" name="frm" id="frm">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <label title='nm_propinsi'>Nm Propinsi</label>
                        <input type="text" ng-model="h.nm_propinsi" id="h_nm_propinsi" class="form-control input-sm"    maxlength="50"  >
                    </div>
                </div>
...
app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope, $http, NgTableParams, SfService, FileUploader) {
    SfService.setUrl("<?php echo e(url('trs_local_ms_propinsi')); ?>");
    ...
    $scope.m = [];
     ...
     var uploader = $scope.uploader = new FileUploader({
        ...
        onBeforeUploadItem: function(item) {
            ...
            item.formData = [{ id: $scope.h.rowid, path: 'trs_local_ms_propinsi', s: 'i', userid: $scope.f.userid, plant: $scope.f.plant }];
        },
    ...
    $scope.oGallery = function() {
        SfGetMediaList('trs_local_ms_propinsi/' + $scope.h.rowid, function(jdata) {
            $scope.m = jdata.files;
            $scope.$apply();
        });
    }
    ...
    $scope.oLookup = function(id, selector, obj) {
     ...
     $scope.oLog=function(){
        SfLog('trs_local_ms_propinsi',$scope.h.rowid);
    }
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\webmon\backend\resources\views/trs/local/ms_propinsi/ms_propinsi_frm.blade.php ENDPATH**/ ?>