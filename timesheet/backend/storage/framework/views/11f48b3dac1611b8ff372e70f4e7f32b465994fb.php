        ...
        <div class="m-b-5 form-inline">
            <div class="pull-right">
                ...
                <div ng-show="f.tab=='frm'">
                    ...
                    <span ng-if="f.crud!='c'"> <?php $__env->startComponent('layouts.common.coloradmin.chat',['route'=>'trs_local_ms_kabupaten','id'=>'h.rowid']); ?>  <?php echo $__env->renderComponent(); ?> </span>
                </div>
            </div>
            ...
            <div id="div1" class="table-responsive">
                <table ng-table="tableList" show-filter="false" class="table table-condensed table-hover" style="white-space: nowrap;">
                    <tr ng-repeat="v in $data" class="pointer" ng-click="oShow(v.rowid)">
                        ...
                        <td title="'Nm Kabupaten'" filter="{nm_kabupaten: 'text'}" sortable="'nm_kabupaten'">{{v.nm_kabupaten}}</td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <form action="#" name="frm" id="frm">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" ng-model="h.nm_kabupaten" id="h_nm_kabupaten" class="form-control input-sm"    maxlength="50"  >
                    </div>
                </div>
    ...
    $scope.m = [];
     ...
     var uploader = $scope.uploader = new FileUploader({
        ...
        onBeforeUploadItem: function(item) {
            ...
            item.formData = [{ id: $scope.h.rowid, path: 'trs_local_ms_kabupaten', s: 'i', userid: $scope.f.userid, plant: $scope.f.plant }];
        },
