<!-- ------------------------------------------------------------------------------- -->
<?php $__env->startSection('title'); ?>Group User <?php $__env->stopSection(); ?>
<!-- ------------------------------------------------------------------------------- -->
<?php $__env->startSection('title-small'); ?>System <?php $__env->stopSection(); ?>
<!-- ------------------------------------------------------------------------------- -->
...
<?php $__env->startSection('content'); ?>
                    ...
                    <div ng-show="f.tab=='list'">
                        <div class="input-group">
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-success btn-sm"><i class="fa fa fa-print"></i></button>
            ...
            <div ng-show="f.tab=='list'">
                ...
                <div id="div1" class="table-responsive">
                    <table ng-table="tableList" show-filter="false" class="table table-condensed table-hover"
                        ...
                        <tr ng-repeat="v in $data" class="pointer" ng-click="oShow(v.group_id)">
                            <td title="'Group ID'" filter="{group_id: 'text'}" sortable="'group_id'">{{ v . group_id }}
                            </td>
                ...
                <form action="#" name="frm" id="frm">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <input type="text" ng-model="h.group_id" id="h_group_id" class="form-control input-sm"
                                required="" ng-readonly="f.crud!='c'">
                        </div>
                        <div class="col-sm-4">
                            <label>Group Name</label>
                            <input type="text" ng-model="h.group_name" id="h_group_name" class="form-control input-sm"
                                required="">
                        </div>
                        <div class="col-sm-4">
                            <label>Note</label>
                            <input type="text" ng-model="h.note" id="note" class="form-control input-sm">
                        </div>
                    </div>
    ...
    <script>
        app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope, $http,
            ...
            SfService.setUrl("<?php echo e(url('sys_sygroup')); ?>");
            ...
            $scope.oLog = function() {
                SfLog('sys_sygroup', $scope.h.group_id);
            }
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\psda\psda2\backend\resources\views/sys/sygroup/sygroup_frm.blade.php ENDPATH**/ ?>