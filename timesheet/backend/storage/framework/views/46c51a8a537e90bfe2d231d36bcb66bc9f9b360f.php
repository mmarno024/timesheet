            ...
            <form action="#" name="frm" id="frm">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <label>Parent</label>
                        <div class="input-group">
                            <input type="text" ng-model="h.parent" id="h_parent" class="form-control input-sm" readonly maxlength="">
                            <div class="input-group-btn">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" ng-model="h.order_no" id="h_order_no" class="form-control input-sm" awnum="default" maxlength="">
                    </div>
                </div>
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\psda\psda2\backend\resources\views/sys/symenu/symenu_frm.blade.php ENDPATH**/ ?>