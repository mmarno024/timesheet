...
<link href="<?php echo e(url('coloradmin')); ?>/assets/css/style_single_prov.css" rel="stylesheet" />
    <style type="text/css">
        ...
        <div class="col-lg-12 col-12 m-0 p-2 bg-white" style="border-radius: 5px;">
            <div class="col-lg-12 col-12 m-0 p-0">
                <div class="col-lg-11 col-12 m-0 p-r-0 p-b-0 p-l-0 p-t-5" style="border:none">
                    <span style="font-size:25px;" ng-if="data_hardware.detail['waterlevel'].status == 'normal' && data_hardware.detail_ews[0].ews_sirine == 0 && data_hardware.detail_ews[0].ews_sirine_reply == 0" class="text-primary text-bold m-l-5">POS WATER LEVEL - {{ data_hardware . pos_name }}</span>
                    <span style="font-size:25px;" ng-if="data_hardware.detail['waterlevel'].status == 'normal' && data_hardware.detail_ews[0].ews_sirine == 1 && data_hardware.detail_ews[0].ews_sirine_reply == 0" class="text-primary text-bold m-l-5">POS WATER LEVEL - {{ data_hardware . pos_name }}</span>
                    <span style="font-size:25px;" ng-if="data_hardware.detail['waterlevel'].status == 'normal' && data_hardware.detail_ews[0].ews_sirine == 0 && data_hardware.detail_ews[0].ews_sirine_reply == 1" class="text-bold m-l-5 blink_blue">POS WATER LEVEL - {{ data_hardware . pos_name }}</span>
                    <span style="font-size:25px;-webkit-text-stroke: 0.1px black" ng-if="data_hardware.detail['waterlevel'].status != 'normal' && data_hardware.detail['waterlevel'].alarm_status == 3" class="text-bold m-l-5 blink_yellow">POS WATER LEVEL - {{ data_hardware . pos_name }}</span>
                    <span style="font-size:25px;" ng-if="data_hardware.detail['waterlevel'].status != 'normal' && data_hardware.detail['waterlevel'].alarm_status == 4" class="text-bold m-l-5 blink_orange">POS WATER LEVEL - {{ data_hardware . pos_name }}</span>
                    <span style="font-size:25px;" ng-if="data_hardware.detail['waterlevel'].status != 'normal' && (data_hardware.detail['waterlevel'].alarm_status >= 5 && data_hardware.detail['waterlevel'].alarm_status < 8)" class="text-bold m-l-5 blink_red">POS WATER LEVEL - {{ data_hardware . pos_name }}</span>
                </div>
                    ...
                    <div class="image gallery-group-1 m-0" style="width: 100%;padding:0;border-radius: 5px">
                        <div class="image-inner">
                            <a ng-if="data_hardware.device_img == NULL" href="<?php echo e(url('coloradmin')); ?>/assets/img/broken_image.png" data-lightbox="gallery-group-1">
                                <img style="border-radius:5px;height:100%;" ng-if="data_hardware.device_img == NULL" src="<?php echo e(url('coloradmin')); ?>/assets/img/broken_image.png" alt="" />
                            </a>
                            <a ng-if="data_hardware.device_img != NULL" href="<?php echo e(url('device_img')); ?>/{{ data_hardware . device_img . img_name }}" data-lightbox="gallery-group-1">
                                <img style="border-radius:5px;height:100%;" ng-if="data_hardware.device_img != NULL" src="<?php echo e(url('device_img')); ?>/{{ data_hardware . device_img . img_name }}" alt=""/>
                            </a>
...
<?php echo $__env->make('layouts.colorreport_blank', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kalsel\psda\admin\backend\resources\views/trs/local/trs_view/trs_view_single_prov_frm.blade.php ENDPATH**/ ?>