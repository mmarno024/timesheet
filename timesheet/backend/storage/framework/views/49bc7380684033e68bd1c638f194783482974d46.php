...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(url('coloradmin')); ?>/assets/img/icon-report.png">
...
<body ng-app="sfApp" ng-controller="topCtrl" id="topCtrl">
    <div ng-app="sfApp" ng-controller="mainCtrl" id="mainCtrl">
        ...
        <div id="page-container" class="page-container fade page-without-sidebar page-header-fixedxxx">
            <div id="header" class="header navbar navbar-default navbar-fixed-topxxx">
                <div class="container-fluid">
                    <div class="navbar-header" style="white-space: nowrap;">
                        <a href="<?php echo e(url('home')); ?>" class="navbar-brand"><span class="navbar-logo"></span> <?php echo $__env->yieldContent('title'); ?></a>
                    </div>
                    <ul class="nav navbar-nav navbar-right">
                        <li class="p-10">
                            <button class="btn btn-sm btn-default" onclick="window.print()"> <i class="fa fa-print"></i> </button>
                        </li>
                        <li class="p-10 hidden">
                            <button class="btn btn-sm btn-default" onclick="exportPdf(window.location)"> <i class="fa fa-file-pdf-o"></i> </button>
                        </li>
                        <li class="p-10">
                            <button class="btn btn-sm btn-default" onclick="oExcel()"> <i class="fa fa-file-excel-o"></i> </button>
                        </li>
                        <li class="p-10">
                            <button class="btn btn-sm btn-default" onclick="window.close()"> <i class="fa fa-times"></i> </button>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="content">
                <div class="row">
                    <div class="" id="content-left"><?php echo $__env->yieldContent('content-left'); ?></div>
                    <div class="col-md-12" id="content-mid">
                        ...
                        <div><?php echo $__env->yieldContent('footer'); ?></div>
                    </div>
                    <div class="" id="content-right"><?php echo $__env->yieldContent('content-right'); ?></div>
                </div>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\tatonas\webmon\backend\resources\views/layouts/colorreport.blade.php ENDPATH**/ ?>