            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-sm-1">
                            <label>&nbsp;</label>
                            <button type="button" class="btn btn-sm btn-block btn-success" ng-click="oLoadDash();"><i
                            ...
                            <tr ng-repeat="v in $data" class="pointer" ng-click="oSet(v.plant,v.flag,$index,v)">
                                ...
                                <td title="'#'" class="text-center">
                                    <span ng-show="v.flag!=1" class="text-danger"><i class="fa fa-circle"></i>
                                        Blocked</span>
                                    <span ng-show="v.flag==1" class="text-success"><i class="fa fa-circle"></i>
                                        Allowed</span>
                                </td>
                            </tr>
                        </table>
                    ...
                    <ul>
                        <li class="pointer" ng-click="oLoadMember(v.key2,'user_plant')"
                            ng-repeat="v in audit.user_plant | filter:r.qdash">{{ v . key2 }} - <span
                                class="text-success">{{ v . rel_key2_plant . plantname }}</span> <span
                    ...
                    <ul>
                        <li class="pointer" ng-click="oLoadMember(v.key2,'user_group')"
                            ng-repeat="v in audit.user_group | filter:r.qdash">{{ v . key2 }} - <span
                                class="text-success">{{ v . rel_key2_group . group_name }}</span> <span
                                class="text-danger">{{ v . key3 }}</span></li>
                    </ul>
                    ...
                    <ul>
                        <li class="pointer" ng-click="oLoadMember(v.key2,'user_access')"
                            ng-repeat="v in audit.user_access | filter:r.qdash">{{ v . key2 }} - <span
                                class="text-success">{{ v . rel_key2_access . accessname }}</span> <span
                                class="text-danger">{{ v . key3 }}</span></li>
                    </ul>
                    ...
                    <ul>
                        <li class="pointer" ng-click="oLoadMember(v.key2,'group_menu')"
                            ng-repeat="v in audit.group_menu | filter:r.qdash">{{ v . key2 }} - <span
                                class="text-success">{{ v . rel_key2_menu . label }}</span> <span
                                class="text-danger">{{ v . key3 }}</span></li>
                    </ul>
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\psda\psda2\backend\resources\views/sys/sylink/sylink_frm.blade.php ENDPATH**/ ?>