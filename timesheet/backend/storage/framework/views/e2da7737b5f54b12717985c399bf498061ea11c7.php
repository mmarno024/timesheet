    ...
    <div data-scrollbar="true" data-height="100%">
        ...
        <ul class="nav">
            <li class="nav-profile">
                <div class="image">
                    <a href="javascript:;"><img src="<?php echo e(Auth::check()&&Auth::user()->url_img!=null? \App\Sf::fileFtpUrl(Auth::user()->url_img):url('coloradmin/assets/img/user-13.jpg')); ?>" onerror="this.src='<?php echo e(url('coloradmin/assets/img/ionic.png')); ?>'"/></a>
                </div>
                <div class="info">
        ...
        <!-- begin sidebar nav -->
        <ul class="nav">
            <li class="nav-header"><a href="<?php echo e(url('sys_system_change_plant')); ?>"> Plant : <?php echo e(\Session::get('plant')); ?></a></li>
            ...
            <?php foreach ($dtMenu as $k1 => $v1): ?>
            	...
            	<?php else: ?>
            		<li class="has-sub"><a href="javascript:;"><b class="caret pull-right"></b><i class="<?php echo e($v1->icon==''?'fa fa-suitcase':$v1->icon); ?>"></i>
								                ...
								                <ul class="sub-menu">
								                	...
								                	<?php foreach ($v3->rel_symenu as $k4 => $v4): ?>
								                    	<?php if ($v4->rel_symenu->count() == 0): ?>
								                    		<li><a href="<?php echo e(url(@$v4->url==''?'#':@$v4->url)); ?>"><?php echo e(@$v4->label); ?></a></li>
							                    		<?php else: ?>
							                    			<li class="has-sub"><a href="javascript:;"><b class="caret pull-right"></b>
												                ...
												                <ul class="sub-menu">
												                	...
												                	<?php foreach ($v4->rel_symenu as $k5 => $v5): ?>
												                    	<?php if ($v5->rel_symenu->count() == 0): ?>
												                    		<li><a href="<?php echo e(url(@$v5->url==''?'#':@$v5->url)); ?>"><?php echo e(@$v5->label); ?></a></li>
											                    		<?php else: ?>
											                    			<li class="has-sub"><a href="javascript:;"><b class="caret pull-right"></b>
...
<div class="sidebar-bg hidden-print"></div><?php /**PATH C:\xampp\htdocs\tatonas\new_webmon\backend\resources\views/layouts/common/coloradmin/sidebar_left.blade.php ENDPATH**/ ?>