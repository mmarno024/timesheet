                    ...
                    <table ng-table="tableList" show-filter="false" class="table table-condensed table-hover"
                        ...
                        <tr ng-repeat="v in $data" class="pointer" ng-click="oShow(v.menu_id)">
                            ...
                            <td title="'Label'" filter="{label: 'text'}" sortable="'label'">
                                ...
                                <i class="fa fa-arrow-right" ng-show="v.rel_parent.rel_parent.rel_parent.label!=null"></i>
                            ...
                            <td title="'Redirect'" filter="{redirect: 'text'}" sortable="'redirect'">{{ v . redirect }}
                            </td>
                            <td title="'Icon'" filter="{icon: 'text'}" sortable="'icon'">{{ v . icon }}</td>
                            <td title="'Note'" filter="{note: 'text'}" sortable="'note'">{{ v . note }}</td>
                            <td title="'Order No'" filter="{order_no: 'text'}" sortable="'order_no'">{{ v . order_no }}
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div ng-show="f.tab=='frm'">
                <form action="#" name="frm" id="frm">
                    <div class="row">
                        <div class="col-sm-4">
                            <label>Menu Id</label>
                            <input type="text" ng-model="h.menu_id" id="h_menu_id" class="form-control input-sm" readonly
                                maxlength="">
                            <label>Label</label>
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="text" ng-model="h.redirect" id="h_redirect" class="form-control input-sm"
                                maxlength="100">
                            <label>Parent</label>
                            <div class="input-group">
                                <input type="text" ng-model="h.parent" id="h_parent" class="form-control input-sm"
                                    data-min-length="0" data-html="1" data-auto-select="true" data-animation="am-flip-x"
                                    bs-options="icon.value as icon.html for icon in getParents($viewValue)" bs-typeahead>
                                <div class="input-group-btn">
                                    <button class="btn btn-default btn-sm" type="button"
                                        ng-click="oLookup('parent','h_parent')"><i class="fa fa-search"></i></button>
                                </div>
                            </div>
                            <label>Icon</label>
                            <input type="text" ng-model="h.icon" id="h_icon" class="form-control input-sm" maxlength="30"
                                data-animation="am-flip-x" bs-options="state  for state in getAddress($viewValue)"
                                data-auto-select="true" bs-typeahead>
                        </div>
                        <div class="col-sm-4">
                            <label>Note</label>
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\pln\updk\backend\resources\views/sys/symenu/symenu_frm.blade.php ENDPATH**/ ?>