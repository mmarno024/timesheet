...
<link href="<?php echo e(url('coloradmin')); ?>/assets/css/style_all_kab.css" rel="stylesheet" />
    <style type="text/css">
    ...
    <div class="col-lg-12 col-12 m-0 p-2">
        ...
        <div ng-if="countNotif >= 1" class="col-lg-4 col-12 m-0 p-2 bg-black" style="border-radius: 5px;">
            ...
            <span style="font-size:2vh;color:white; padding:0 5px 0 5px" class="text-bold runword button_alarm_red"></span>
        </div>
    ...
    <div ng-repeat="(k,v) in data_hardware" class="col-lg-6 col-12 m-0 p-2">
        <div class="col-lg-12 col-12 m-0 p-2 bg-white" style="border-radius: 5px;">
            <div class="col-lg-12 col-12 m-0 p-0">
                <div class="col-lg-11 col-11 m-0 p-r-0 p-b-0 p-l-0 p-t-5" style="border:none">
                    <span ng-if="v.detail['waterlevel'].status == 'normal' && v.detail_ews[0].ews_sirine == 0 && v.detail_ews[0].ews_sirine_reply == 0 " style="font-size:18px;" class="text-primary text-bold m-l-5">POS WATER LEVEL - {{ v . pos_name }}</span>
                    <span ng-if="v.detail['waterlevel'].status == 'normal' && v.detail_ews[0].ews_sirine == 1 && v.detail_ews[0].ews_sirine_reply == 0" style="font-size:18px;" class="text-primary text-bold m-l-5">POS WATER LEVEL - {{ v . pos_name }}</span>
                    <span ng-if="v.detail['waterlevel'].status == 'normal' && v.detail_ews[0].ews_sirine == 0 && v.detail_ews[0].ews_sirine_reply == 1" style="font-size:18px;" class="text-bold m-l-5 blink_blue">POS WATER LEVEL - {{ v . pos_name }}</span>
                    <span ng-if="v.detail['waterlevel'].status != 'normal' && v.detail['waterlevel'].alarm_status == 3" style="font-size:18px;-webkit-text-stroke: 0.1px black" class="text-bold m-l-5 blink_yellow">POS WATER LEVEL - {{ v . pos_name }}</span>
                    <span ng-if="v.detail['waterlevel'].status != 'normal' && v.detail['waterlevel'].alarm_status == 4" style="font-size:18px;" class="text-bold m-l-5 blink_orange">POS WATER LEVEL - {{ v . pos_name }}</span>
                    <span ng-if="v.detail['waterlevel'].status != 'normal' && (v.detail['waterlevel'].alarm_status >= 5 && v.detail['waterlevel'].alarm_status < 8)" style="font-size:18px;" class="text-bold m-l-5 blink_red">POS WATER LEVEL - {{ v . pos_name }}</span>
                </div>
                <div class="col-lg-1 col-1 m-0 p-r-0 p-b-0 p-l-0 p-t-5 text-right" style="border:none">
                    <a href="" style="cursor: pointer" title="Open Full Windows">
                        <img src="<?php echo e(url('coloradmin')); ?>/assets/icon/expand-arrows.png" width="18px;" alt="" style="" ng-click="oExpand(v.hardware)" />
                    </a>
                </div>
            </div>
            <div class="col-lg-8 col-md-12 col-sm-12 m-0 p-0" style="">
                <div id="gallery" class="col-lg-12 col-12 gallery m-0 p-2" style="">
                    <div class="image gallery-group-1 m-0" style="width: 100%;padding:0;border-radius: 5px">
                        <div class="image-inner">
                            <a ng-if="v.device_img == NULL" href="<?php echo e(url('coloradmin')); ?>/assets/img/broken_image.png" data-lightbox="gallery-group-1">
                                <img ng-if="v.device_img == NULL" src="<?php echo e(url('coloradmin')); ?>/assets/img/broken_image.png" alt="" style="border-radius:5px;height:100%" />
                            </a>
                            <a ng-if="v.device_img != NULL" href="<?php echo e(url('device_img')); ?>/{{ v . device_img . img_name }}" data-lightbox="gallery-group-1">
                                <img ng-if="v.device_img != NULL" src="<?php echo e(url('device_img')); ?>/{{ v . device_img . img_name }}" alt="" style="border-radius:5px;height:100%" />
                            </a>
                            <span class="image-caption" style="font-size:15px;border-radius:0 3px 3px 0;margin-top:3%;">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 m-0 p-0" style="">
                <div class="col-lg-12 col-12 m-0" style="padding:0 5px 0 5px;">
                    <span class="text-primary">status level air : </span>
                ...
                <div class="col-lg-12 col-12 m-0 p-3 text-center" style="">
                        ...
                        <div class="card l-bg-green-dark">
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="m-b-0 text-left" style="">
                                    <span style="font-size:20px;" class="card-title m-t-0 m-b-0 text-white">Level Air</span>
                                    <span style="font-size:17px;" class="card-title m-t-0 m-b-0 text-white"> <i>({{ v . detail['waterlevel'].sensor.units }})</i></span>
                                </div>
                                <div class="row align-items-center m-b-5 d-flex" style="">
                                    <div class="col-lg-12 col-12" style="">
                                        <h1 class="d-flex align-items-center m-t-5 text-bold text-white" style="text-align: right;-webkit-text-stroke: 0.8px black">{{ v . detail['waterlevel'].value }}</h1>
                                    </div>
                                    <div class="col-lg-6 col-6 text-right" style="float:left;">
                                        <span style="font-size:17px;text-align: right">{{ v . detail['waterlevel'].val_min }}</span> <i class="fa fa-arrow-down text-primary"></i>
                                    </div>
                                    <div class="col-lg-6 col-6 text-right" style="float:left;">
                                        <span style="font-size:17px;text-align: right">{{ v . detail['waterlevel'].val_max }}</span> <i class="fa fa-arrow-up text-danger"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-12 col-12 m-0 p-3 text-center" style="">
                    <div class="col-lg-12 col-12 m-t-0 m-r-0 m-b-5 m-l-0 p-0 text-center" style="">
                        <div class="card l-bg-blue-dark">
                            <div class="card-statistic-3 p-4">
                                <div class="card-icon card-icon-large"><i class="fa fa-battery-3 fa-3x"></i></div>
                                <div class="m-b-0 text-left" style="">
                                    <span style="font-size:12px" class="card-title m-t-0 m-b-0 text-white">Batt.</span>
                                    <span style="font-size:10px" class="card-title m-t-0 m-b-0 text-white"> <i>({{ v . detail['battery'].sensor.units }})</i></span>
                                </div>
                                <div class="row align-items-center m-b-0 d-flex" style="">
                                    <div class="col-lg-12 col-12" style="text-align:right">
                                        <span style="font-size:18px" class="d-flex align-items-center m-t-0 text-right text-white">{{ v . detail['battery'].value }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12 col-12 m-0 p-0 text-center" style="">
                        <div class="card l-bg-orange-dark">
                            <div class="card-statistic-3 p-4">
                                <div class="card-icon card-icon-large"><i class="fa fa-thermometer fa-3x"></i></div>
                                <div class="m-b-0 text-left" style="">
                                    <span style="font-size:12px" class="card-title m-t-0 m-b-0 text-white">Temp.</span>
                                    <span style="font-size:10px" class="card-title m-t-0 m-b-0 text-white"> <i>({{ v . detail['devicetemp'].sensor.units }})</i></span>
                                </div>
                                <div class="row align-items-center m-b-0 d-flex" style="">
                                    <div class="col-lg-12 col-12" style="text-align:right">
                                        <span style="font-size:18px" class="d-flex align-items-center m-t-0 text-right text-white">{{ v . detail['devicetemp'].value }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-12 col-12 m-t-0 m-r-0 m-b-5 m-l-0" style="padding:0 5px 0 5px;">
                    <div class="btn-group" style="margin:0;padding:0;width:100%">
                        <a ng-repeat="(ki, vi) in v.detail['waterlevel']['properties']['color_step']" class="btn btn-{{vi}} btn-xs p-0 m-0 text-center" style="font-size:10px;width:25%">{{ v.detail['waterlevel']['properties']['value_step'][ki] }}</a>
                    </div>
                </div>
                <div class="col-lg-12 col-12 m-0" style="padding:0 5px 0 5px;">
                ...
                <div class="col-lg-12 col-12 m-0" style="padding:0 5px 0 5px;">
                    <div class="col-lg-2 col-2 m-0 p-0" style="float:left;">
        ...
        app.controller('mainCtrl', ['$scope', '$http', '$interval', 'NgTableParams', 'SfService', 'FileUploader',
            function($scope, $http, $interval, NgTableParams, SfService, FileUploader) {
                ...
                $scope.oViewAll = function() {
                    SfService.httpGet("trs_local_trs_view_ak_data", {
                        plant: $scope.f.plant
                    }, function(jdata) {
                ...
                $scope.oEwsOff = function (hardware) {
                    Swal.fire({
                        ...
                        if (result.value == true) {
                            window.location = 'trs_local_trs_ews_status?hc=' + hardware + '&bs=' + '&st=down';
                            Swal.fire('', 'Perintah dikirim !', 'success')
                        }
                    })
                }
                $scope.oExpand = function(hid) {
                    window.location = 'trs_local_trs_view_sk?id=' + hid;
                }
...
<?php echo $__env->make('layouts.colorreport_blank', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kalsel\psda\admin\backend\resources\views/trs/local/trs_view/trs_view_all_kab_frm.blade.php ENDPATH**/ ?>