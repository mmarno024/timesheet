            ...
            <li>
                <form class="navbar-form full-width" action="<?php echo e(url('src')); ?>">
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Enter keywordxxx" name="search_keyword" />
...
<?php /**PATH C:\xampp\htdocs\tatonas\webmon\backend\resources\views/layouts/common/coloradmin/nav_top.blade.php ENDPATH**/ ?>