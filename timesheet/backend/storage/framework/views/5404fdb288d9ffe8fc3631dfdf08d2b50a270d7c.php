            ...
            <div ng-show="f.tab=='frm'">
                <form action="#" name="frm" id="frm">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <label title='versi_data_logger'>Versi Data Logger</label>
                            <input type="text" ng-model="h.versi_data_logger" id="h_versi_data_logger"
                                class="form-control input-sm" ng-readonly>
                        </div>
                        <div class="col-sm-3">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            ...
                            <input type="text" ng-model="h.perkalian" id="h_perkalian" class="form-control input-sm"
                                placeholder="1" awnum>
                        </div>
                        <div class="col-sm-3">
                            <label title='penjumlahan'>Penjumlahan</label>
                            <input type="text" ng-model="h.penjumlahan" id="h_penjumlahan" class="form-control input-sm"
                                placeholder="0" awnum>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\besai\backend\resources\views/trs/local/mst_hardware/mst_hardware_frm.blade.php ENDPATH**/ ?>