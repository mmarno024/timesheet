            ...
            <div class="m-b-5 form-inline">
                <div class="col-sm-12 m-b-10">
                    ...
                    <div class="col-sm-12 p-0" style="margin:10px 0 0 0;">
                        <a href="<?php echo e(url('trs_local_trs_raw_detail_all')); ?>" class="text-bold m-0 p-0">Lihat detail Logger lainnya &raquo;</a>
                    </div>
                    <hr />
                </div>
            </div>
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\wmon_fix\admin\backend\resources\views/trs/local/trs_raw/trs_raw_frm_detail.blade.php ENDPATH**/ ?>