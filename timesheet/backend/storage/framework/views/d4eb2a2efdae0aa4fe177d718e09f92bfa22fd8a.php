<div id="header" class="header navbar navbar-default navbar-fixed-topxxx">
    ...
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            <a href="<?php echo e(url('home')); ?>" class="navbar-brand"><span class="navbar-logo"></span> <?php echo e(\App\Sf::getParsys('APP_LABEL')); ?></a>
        ...
        <div class="collapse navbar-collapse pull-left" id="top-navbar">
            <ul class="nav navbar-nav">
                <li class="hidden"><a href="javascript:;" data-click="sidebar-minify" style="padding-bottom: 0px"><i class="fa fa-bars fa-2x"></i></a></li>
            </ul>
        </div>
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown navbar-user">
              ...
              <img src="<?php echo e(Auth::check()&&Auth::user()->url_img!=null? \App\Sf::fileFtpUrl(Auth::user()->url_img):url('coloradmin/assets/img/user-13.jpg')); ?>" onerror="this.src='<?php echo e(url('coloradmin/assets/img/ionic.png')); ?>'" />
              <span class="hidden-xs"><?php echo e(ucwords(strtolower(Auth::check()?Auth::user()->username:'Guest'))); ?></span> <b class="caret"></b>
            </a>
                <ul class="dropdown-menu animated fadeInLeft">
                    ...
                    <li><a href="#" onclick="SfSetUserAttr('default_menu','<?php echo e(str_replace(url('/'), '', Request::fullUrl())); ?>');">Set as Default Menu</a></li>
                    <li class="divider"></li>
                    ...
                    <li class="divider"></li>
                    <li class="hidden"><a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Log Out</a>
    ...
    <!-- end container-fluid -->
</div><?php /**PATH C:\xampp\htdocs\tatonas\new_webmon\backend\resources\views/layouts/common/coloradmin/nav_top.blade.php ENDPATH**/ ?>