...
<body>
    ...
    <div class="frontend-wrapper bg-white">
        ...
        <div class="header text-xs-center img-cover"
            ...
            <div class="h-content">
                <div class="clearfix">
                    <div class="h-logo float-xs-left"><a class="text-white" href="#"><img
                                src="<?php echo e(url('neptuneparalax')); ?>/assets/img/tatonas.png"></a></div>
                    <div class="h-menu float-xs-right">
                        <ul class="list-inline mb-0">
                            ...
                            <li class="list-inline-item"><a class="text-white"
                                    href="<?php echo e(url('/trs_local_trs_raw')); ?>">Logger</a></li>
...
<?php /**PATH C:\xampp\htdocs\tatonas\besai\backend\resources\views/layouts/neptuneparalax.blade.php ENDPATH**/ ?>