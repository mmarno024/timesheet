...
<body ng-app="sfApp" ng-controller="topCtrl" id="topCtrl">
        ...
        <div id="page-container" class="page-container fade page-without-sidebar page-header-fixedxxx">
            ...
            <div class="content p-5">
                <div class="row" style="margin:0 2px 0 2px;">
                    <div class="col-md-12 p-0" id="content-mid">
  ...
  <![endif]-->
    ...
    <script src="<?php echo e(url('coloradmin')); ?>/assets/plugins/chart-js/chart.js"></script>
    <!-- ================== END BASE JS ================== -->
    <!-- ================== BEGIN PAGE LEVEL JS ================== -->
    <script src="<?php echo e(url('coloradmin')); ?>/assets/js/apps.min.js"></script>
    <script src="<?php echo e(url('coloradmin')); ?>/assets/js/chart-js.demo.min.js"></script>
    <!-- ================== END PAGE LEVEL JS ================== -->
    <script>
...
<?php /**PATH C:\xampp\htdocs\tatonas\besai\backend\resources\views/layouts/colorfront.blade.php ENDPATH**/ ?>