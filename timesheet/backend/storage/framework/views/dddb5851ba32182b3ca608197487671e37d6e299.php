            ...
            <div ng-show="f.tab=='frm'">
                <form action="#" name="frm" id="frm">
                    ...
                    <div class="row" ng-show="f.crud=='c'">
                        <div class="col-sm-12">
                            <h3 class="text-primary">Daftar Sensor</h3>
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\palu\palu1\backend\resources\views/trs/local/mst_sensor/mst_sensor_frm.blade.php ENDPATH**/ ?>