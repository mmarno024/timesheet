...
<body ng-app="sfApp" ng-controller="topCtrl" id="topCtrl" onkeypress="return disableCtrlKeyCombination(event);"
    ...
    <div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixedxxx page-sidebar-minified ">
        ...
        <!-- end #sidebar -->
        <!-- begin #content -->
        <div ng-app="sfApp" ng-controller="mainCtrl" id="mainCtrl" class="p-0 m-0">
            <!-- begin breadcrumb -->
...
<?php /**PATH C:\xampp\htdocs\tatonas\webmon\monitoring\backend\resources\views/layouts/coloradmin_minified_front.blade.php ENDPATH**/ ?>