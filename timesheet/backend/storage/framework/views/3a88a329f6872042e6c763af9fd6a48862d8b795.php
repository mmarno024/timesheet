            ...
            <a style="height:100%;width:600px;" class="navbar-brand">
                <table border="0" cellspacing="">
                    <tr>
                        ...
                        <td style="font-weight:bold;color:#008cd7;font-size:17px;line-height:1">
                            <i class="fa fa-home"></i>&nbsp;<?php echo e(\App\Sf::getPlantname(Auth::user()->def_plant)); ?>
                    ...
                    <tr>
                        ...
                        <td style="color:666;font-size:12px;line-height:1">
                            ...
                            <?php echo e(\App\Sf::getAddr(Auth::user()->def_plant)); ?></td>
                    </tr>
                </table>
            </a>
...
<?php /**PATH C:\xampp\htdocs\tatonas\webmon\monitoring\a_data\monitoring_back\backend\resources\views/layouts/common/coloradmin/nav_top.blade.php ENDPATH**/ ?>