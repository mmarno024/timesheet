            ...
            <div ng-show="f.tab=='frm'">
                <form action="#" name="frm" id="frm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <label title='status'>Condition</label>
                            <select class="form-control input-sm" id="h_status" ng-model="h.status">
                                <option ng-repeat="v in status" value="{{ v }}">{{ v }}</option>
                            </select>
                        </div>
                        <div class="col-sm-2">
                    ...
                    <div ng-show="h.filter_ip=='yes'" class="col-sm-4 p-10 m-r-10"
                        ...
                        <div class="col-sm-12 m-0 p-0">
                            <h5 class="text-primary">IP Address List</h5>
                        ...
                        <div class="col-sm-12 m-0 p-0">
                            <button type="button" class="btn btn-sm btn-primary" ng-click="addRowIp();">Add IP
                                Address</button>
                        </div>
                    </div>
                    ...
                    <div ng-show="h.filter_plant=='yes'" class="col-sm-7 p-10"
                        style="border-radius:5px;border:1px solid #0099cc">
                        <h5 class="text-primary">Project List</h5>
                        <div class="col-sm-12 m-0 p-0">
                                    ...
                                    <div class="col-sm-12 m-t-5">
                                        ...
                                        <div class="col-sm-5 m-0 p-0">
                                            <button type="button" class="btn btn-xs btn-success"
                                                ng-click="addRowHw($index)">Add Hardware</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12 m-0 p-0">
                            <button type="button" class="btn btn-sm btn-primary" ng-click="addRowPlant()">Add Project</button>
                        </div>
                    </div>
                </form>
                <div class="col-sm-12 p-10">
                    <hr />
                    <h5 class="text-primary">URL API List</h5>
                    <hr />
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kalsel\psda\admin\backend\resources\views/trs/local/trs_api/trs_api_frm.blade.php ENDPATH**/ ?>