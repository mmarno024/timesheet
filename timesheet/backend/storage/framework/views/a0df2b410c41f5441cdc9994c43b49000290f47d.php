...
<?php $__env->startSection('content'); ?>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-3">
                            ...
                            <div class="input-group">
                                <input type="text" ng-model="d.key1" id="d_key1" class="form-control input-sm" readonly
                                    maxlength="">
                                <div class="input-group-btn">
                                    <button class="btn btn-default btn-sm" type="button"
                                        ng-click="oLookup(f.menuSelected[3],'d_key1')"><i class="fa fa-search"></i></button>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-2">
                            <label>Cari : </label>
                            <input type="text" ng-model="f.qdash" class="form-control input-sm" maxlength=""
                                placeholder="Search" ng-enter="oLoadDash();">
                        </div>
                        <div class="col-sm-2" ng-if="f.menuSelected[5]=='syaccess'">
                            ...
                            <select class="form-control input-sm" ng-model="f.bydept" ng-change="oLoadDash()">
                                <option ng-repeat="v in [['0','All Department'],['1','By Department']]" ng-value="v[0]"
                                    ng-selected="v[1]=='0'">{{ v[1] }}</option>
                            </select>
                        </div>
                        <div class="col-sm-1">
                            <label>&nbsp;</label>
                            <button type="button" class="btn btn-sm btn-block btn-primary" ng-click="oLoadDash();"><i
                    ...
                    <div class="row" ng-if="f.bydept=='1'">
                        <div class="col-sm-3">
                            ...
                            <div class="input-group">
                                <input type="text" ng-model="d.dept" id="d_dept" class="form-control input-sm" readonly
                                    maxlength="">
                                <div class="input-group-btn">
                                    <button class="btn btn-default btn-sm" type="button"
                                        ng-click="oLookup('dept','d_dept')"><i class="fa fa-search"></i></button>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <label class="text-capitalize">Department Name</label>
                            <input type="text" ng-model="d.dept_name" id="d_dept_name" class="form-control input-sm"
                                readonly maxlength="">
                        </div>
                    </div>
                    <hr>
                    <div class="table-responsive" ng-show="f.menuSelected[5]=='syplant'">
                        <table ng-table="tableDash" show-filter="false" class="table table-condensed table-hover"
                            ...
                            <tr ng-repeat="v in $data" class="pointer" ng-click="oSet(v.plant,v.flag,$index,v)">
                                ...
                                <td title="'Plant Name'" filter="{plantname: 'text'}" sortable="'plantname'">
                                    {{ v . plantname }}</td>
                                <td title="'#'" class="text-center">
                                    <span ng-show="v.flag!=1" class="text-danger"><i class="fa fa-circle"></i>
                                        Blocked</span>
                                    <span ng-show="v.flag==1" class="text-primary"><i class="fa fa-circle"></i>
                                        Allowed</span>
                                </td>
                            </tr>
                        </table>
                    ...
                    <div class="table-responsive" ng-show="f.menuSelected[5]=='sygroup'">
                        <table ng-table="tableDash" show-filter="false" class="table table-condensed table-hover"
                            ...
                            <tr ng-repeat="v in $data" class="pointer" ng-click="oSet(v.group_id,v.flag,$index,v)">
                                <td title="'Group ID'" filter="{group_id: 'text'}" sortable="'group_id'">
                                    {{ v . group_id }}</td>
                                <td title="'Group Name'" filter="{group_name: 'text'}" sortable="'group_name'">
                                    {{ v . group_name }}</td>
                                <td title="'#'" class="text-center">
                                    <span ng-show="v.flag!=1" class="text-danger"><i class="fa fa-circle"></i>
                                        Blocked</span>
                    ...
                    <div class="table-responsive" ng-show="f.menuSelected[5]=='symenu'">
                        <table ng-table="tableDash" show-filter="false" class="table table-condensed table-hover"
                            ...
                            <tr ng-repeat="v in $data" class="pointer" ng-click="oSet(v.menu_id,v.flag,$index,v)">
                                <td title="'Menu Id'" filter="{menu_id: 'text'}" sortable="'menu_id'">{{ v . menu_id }}
                                </td>
                                <td title="'Label'" filter="{label: 'text'}" sortable="'label'">
                                    {{ v . rel_parent . rel_parent . rel_parent . rel_parent . label }}
                                    <i class="fa fa-arrow-right"
                                        ng-show="v.rel_parent.rel_parent.rel_parent.rel_parent.label!=null"></i>
                                    {{ v . rel_parent . rel_parent . rel_parent . label }}
                                    <i class="fa fa-arrow-right"
                                        ng-show="v.rel_parent.rel_parent.rel_parent.label!=null"></i>
                                    {{ v . rel_parent . rel_parent . label }}
                                    <i class="fa fa-arrow-right" ng-show="v.rel_parent.rel_parent.label!=null"></i>
                                    {{ v . rel_parent . label }}
                                    <i class="fa fa-arrow-right" ng-show="v.rel_parent.label!=null"></i> <b
                                        class="text-primary">{{ v . label }}</b>
                                </td>
                    ...
                    <div class="table-responsive" ng-show="f.menuSelected[5]=='syaccess'">
                        <table ng-table="tableDash" show-filter="false" class="table table-condensed table-hover"
                            ...
                            <tr ng-repeat="v in $data" class="pointer" ng-click="oSet(v.accessid,v.flag,$index,v)">
                                <td title="'Accessid'" filter="{accessid: 'text'}" sortable="'accessid'">
                                    {{ v . accessid }}</td>
                                <td title="'Accessname'" filter="{accessname: 'text'}" sortable="'accessname'">
                                    {{ v . accessname }}</td>
                                <td title="'Scope'" filter="{location: 'text'}" sortable="'location'">
                                    <span ng-show="v.location==1" class="text-danger">By Plant</span>
                                    <span ng-show="v.location!=1">All Plant</span>
                                </td>
                                <td title="'#'" class="text-center">
                                    <span ng-show="v.flag!=1" class="text-danger"><i class="fa fa-circle"></i>
                                        Blocked</span>
    ...
    <div class="panel panel-primary" ng-show="f.tab=='frm' || f.tab=='list' || f.tab=='audit'">
        ...
        <div class="panel-body">
            <div class="m-b-5 form-inline">
                ...
                <button type="button" class="btn btn-sm btn-inverse" ng-click="f.tab='dash'"><i
                        class="fa fa-arrow-left"></i> Dashboard</button>
            ...
            <div ng-show="f.tab=='audit'">
                <div class="row">
                    <div class="col-sm-3">
                        ...
                        <div class="input-group">
                            <input type="text" ng-model="r.userid" id="r_userid" class="form-control input-sm" readonly
                                maxlength="">
                            <div class="input-group-btn">
                                <button class="btn btn-default btn-sm" type="button"
                                    ng-click="oLookup('userid','r_userid')"><i class="fa fa-search"></i></button>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <label class="text-capitalize">Name</label>
                        <input type="text" ng-model="r.name" id="r_name" class="form-control input-sm" readonly
                            maxlength="">
                    </div>
                    <div class="col-sm-2">
                        <label>&nbsp;</label>
                        <button type="button" class="btn btn-sm btn-block btn-primary"
                            ng-click="oLoadAudit(r.userid);">Load</button>
                    </div>
                    <div class="col-sm-3">
                        <label>Cari : </label>
                        <input type="text" ng-model="r.qdash" class="form-control input-sm" maxlength=""
                            placeholder="Search">
                    </div>
                </div>
                <hr>
                <div>
                    ...
                    <ul>
                        <li class="pointer" ng-click="oLoadMember(v.key2,'user_plant')"
                            ng-repeat="v in audit.user_plant | filter:r.qdash">{{ v . key2 }} - <span
                                class="text-primary">{{ v . rel_key2_plant . plantname }}</span> <span
                                class="text-danger">{{ v . key3 }}</span></li>
                    </ul>
                    <div class="text-bold">User-Group</div>
                    <ul>
                        <li class="pointer" ng-click="oLoadMember(v.key2,'user_group')"
                            ng-repeat="v in audit.user_group | filter:r.qdash">{{ v . key2 }} - <span
                                class="text-primary">{{ v . rel_key2_group . group_name }}</span> <span
                                class="text-danger">{{ v . key3 }}</span></li>
                    </ul>
                    <div class="text-bold">User-Access</div>
                    <ul>
                        <li class="pointer" ng-click="oLoadMember(v.key2,'user_access')"
                            ng-repeat="v in audit.user_access | filter:r.qdash">{{ v . key2 }} - <span
                                class="text-primary">{{ v . rel_key2_access . accessname }}</span> <span
                                class="text-danger">{{ v . key3 }}</span></li>
                    </ul>
                    <div class="text-bold">Group-Menu</div>
                    <ul>
                        <li class="pointer" ng-click="oLoadMember(v.key2,'group_menu')"
                            ng-repeat="v in audit.group_menu | filter:r.qdash">{{ v . key2 }} - <span
                                class="text-primary">{{ v . rel_key2_menu . label }}</span> <span
                                class="text-danger">{{ v . key3 }}</span></li>
                    </ul>
                    <div class="text-bold">Group-Access</div>
                    <ul>
                        <li class="pointer" ng-click="oLoadMember(v.key2,'group_access')"
                            ng-repeat="v in audit.group_access | filter:r.qdash">{{ v . key2 }} - <span
                                class="text-primary">{{ v . rel_key2_access . accessname }}</span> <span
                                class="text-danger">{{ v . key3 }}</span></li>
                    </ul>
                </div>
                ...
                <form action="#" name="frm" id="frm">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <input type="text" ng-model="h.rel" id="h_rel" class="form-control input-sm" readonly
                                maxlength="30">
                            <label>Key 1</label>
                            <input type="text" ng-model="h.key1" id="h_key1" class="form-control input-sm" readonly
                                maxlength="30">
                            <label>Key 2</label>
                            <input type="text" ng-model="h.key2" id="h_key2" class="form-control input-sm" readonly
                                maxlength="30">
                        </div>
                        <div class="col-sm-4">
                            <label>Key 3</label>
                            <input type="text" ng-model="h.key3" id="h_key3" class="form-control input-sm" readonly
                                maxlength="30">
                            <label>Key 4</label>
                            <input type="text" ng-model="h.key4" id="h_key4" class="form-control input-sm" readonly
                                maxlength="30">
                            <label>Key5</label>
                            <input type="text" ng-model="h.key5" id="h_key5" class="form-control input-sm" readonly
                                maxlength="30">
                            <label>Table 1</label>
                            <input type="text" ng-model="h.tbl1" id="h_tbl1" class="form-control input-sm" readonly
                                maxlength="30">
                        </div>
                        <div class="col-sm-4">
                            <label>Table 2</label>
                            <input type="text" ng-model="h.tbl2" id="h_tbl2" class="form-control input-sm" readonly
                                maxlength="30">
                            <label>Table 3</label>
                            <input type="text" ng-model="h.tbl3" id="h_tbl3" class="form-control input-sm" readonly
                                maxlength="30">
                            <label>Table 4</label>
                            <input type="text" ng-model="h.tbl4" id="h_tbl4" class="form-control input-sm" readonly
                                maxlength="30">
                            <label>Table 5</label>
                            <input type="text" ng-model="h.tbl5" id="h_tbl5" class="form-control input-sm" readonly
                                maxlength="30">
                        </div>
                        <div class="col-sm-4">
                        </div>
    ...
    <script>
        app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', function($scope, $http, NgTableParams,
            ...
            $scope.oLookup = function(id, selector, obj) {
                switch (id) {
                    case 'group':
                        ...
                        break;
                    case 'dept':
                        SfLookup("<?php echo e('sys_sydept_lookup'); ?>?plant=" + $scope.f.plant, function(id, name,
                            jsondata) {
                            $("#" + selector).val(id).trigger('input');
                            $scope.oLoadDash();
            ...
            $scope.oSet = function(id, flag, index, v) {
                ...
                if ($scope.f.bydept == '1' && ($scope.d.dept == '' || $scope.d.dept == null || $scope.d
                        .dept == undefined)) {
                    ...
                    SfService.httpGet(SfService.getUrl('_member'), {
                        ...
                        angular.forEach(jdata.data.data, function(item, i) {
                            if (item.rel_key1_user != null) {
                                str += "<li>" + item.key1 + " - " + item
                                    .rel_key1_user.username + "</li>";
                            } else if (item.rel_key1_group != null) {

                                str += "<li>" + item.key1 + " - " + item
                                    .rel_key1_group.group_name + "</li>";
                            }
                        });
                        str += "</ol>";
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\webmon\monitoring\backend\resources\views/sys/sylink/sylink_frm.blade.php ENDPATH**/ ?>