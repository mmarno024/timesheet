                ...
                <div id="div1" class="table-responsive">
                    <table ng-table="tableList" show-filter="false" class="table table-condensed table-hover"
                        ...
                        <tr ng-repeat="v in $data" class="pointer" ng-click="oShow(v.kd_ri)">
                            ...
                            <td title="'Nilai A'" filter="{angka1: 'text'}" sortable="'angka1'">{{ v . angka1 }}</td>
                            <td title="'Nilai B'" filter="{angka2: 'text'}" sortable="'angka2'">{{ v . angka2 }}</td>
                            <td title="'Nilai C'" filter="{angka3: 'text'}" sortable="'angka3'">{{ v . angka3 }}</td>
                    ...
                    <div class="row m-t-10 m-b-10 m-l-2">
                        <div class="col-sm-6 bg-blue-lighter p-10">
                            ...
                            <span class="text-white text-bold">
                                QInflow =
                                ({{ h . angka1 == '' || h . angka1 == null ? 'Nilai A' : h . angka1 }} * <i>WLPetai</i> +
                                {{ h . angka2 == '' || h . angka2 == null ? 'Nilai B' : h . angka2 }} *
                                <i>Rakumulatif</i> -
                                {{ h . angka3 == '' || h . angka3 == null ? 'Nilai C' : h . angka3 }}) m<sup>3</sup>⁄s
...
<?php echo $__env->make('layouts.coloradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatonas\psda\psda2\backend\resources\views/trs/local/mst_rumus_inflow/mst_rumus_inflow_frm.blade.php ENDPATH**/ ?>