...
@section('content')
<link href="{{ url('coloradmin') }}/assets/css/style_all_prov.css" rel="stylesheet" />
    <style type="text/css">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 m-0 p-r-0 p-b-0 p-l-0 p-t-2" style="">
                ...
                <div class="col-lg-1 col-md-1 col-sm-1 m-0 p-0 text-right" style="">
                    <a href="" style="cursor: pointer" title="Open Full Windows">
                        <img src="{{ url('coloradmin') }}/assets/icon/expand-arrows.png" width="12px;" alt="" style="" ng-click="oExpand(v.hardware)" />
                    </a>
                </div>
            </div>
                    ...
                    <div class="image gallery-group-1 m-0" style="width: 100%;padding:0;border-radius: 5px">
                        <div class="image-inner">
                            <a ng-if="v.device_img == NULL" href="{{ url('coloradmin') }}/assets/img/cctv.jpg" data-lightbox="gallery-group-1">
                                <img ng-if="v.device_img == NULL" src="{{ url('coloradmin') }}/assets/img/cctv.jpg" alt="" style="border-radius:5px;" />
                            </a>
                            <a ng-if="v.device_img != NULL" href="{{ url('device_img') }}/@{{ v . device_img . img_name }}" data-lightbox="gallery-group-1">
                                <img ng-if="v.device_img != NULL" src="{{ url('device_img') }}/@{{ v . device_img . img_name }}" alt="" style="border-radius:5px;" />
                            </a>
