...
@section('content')
<link href="{{ url('coloradmin') }}/assets/css/style_single_kab.css" rel="stylesheet" />
    <style type="text/css">
    ...
    <div class="col-lg-12 col-12 m-0 p-2">
        ...
        <div class="col-lg-8 col-12 m-0 p-2 bg-black text-right" style="border-radius: 5px;">
            <span style="font-size:2.5vh;" ng-if="notif_text != 'normal' && data_hardware.detail['waterlevel'].alarm_status == 2" class="text-bold button_alarm_yellow p-t-2 p-r-10 p-b-2 p-l-10">AWAS ! LEVEL AIR MEMBERIKAN SINYAL PERINGATAN @{{data_hardware.detail['waterlevel'].status}}</span>
            <span style="font-size:2.5vh;" ng-if="notif_text != 'normal' && data_hardware.detail['waterlevel'].alarm_status == 3" class="text-bold button_alarm_orange p-t-2 p-r-10 p-b-2 p-l-10">AWAS ! LEVEL AIR MEMBERIKAN SINYAL PERINGATAN @{{data_hardware.detail['waterlevel'].status}}</span>
            <span style="font-size:2.5vh;" ng-if="notif_text != 'normal' && data_hardware.detail['waterlevel'].alarm_status >= 4" class="text-bold button_alarm_red p-t-2 p-r-10 p-b-2 p-l-10">AWAS ! LEVEL AIR MEMBERIKAN SINYAL PERINGATAN @{{data_hardware.detail['waterlevel'].status}}</span>
