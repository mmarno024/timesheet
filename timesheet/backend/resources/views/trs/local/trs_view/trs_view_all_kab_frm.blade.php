...
@section('content')
<link href="{{ url('coloradmin') }}/assets/css/style_all_kab.css" rel="stylesheet" />
    <style type="text/css">
    ...
    <div ng-repeat="(k,v) in data_hardware" class="col-lg-6 col-md-6 col-sm-12 m-0 p-2">
        <div class="col-lg-12 col-md-12 col-sm-12 m-0 p-2 bg-white" style="border-radius: 5px;">
            <div class="col-lg-12 col-md-12 col-sm-12 m-0 p-0">
                <div class="col-lg-11 col-md-11 col-sm-11 m-0 p-r-0 p-b-0 p-l-0 p-t-5" style="border:none">
                    <span ng-if="v.detail['waterlevel'].status == 'normal' " style="font-size:18px;" class="text-primary text-bold m-l-5">WL : @{{ v . pos_name }} - EWS : @{{ v.detail_ews[0].ews_location }}</span>
                    <span ng-if="v.detail['waterlevel'].status != 'normal' && v.detail['waterlevel'].alarm_status == 3" style="font-size:18px;-webkit-text-stroke: 0.1px black" class="text-bold m-l-5 blink_yellow">WL : @{{ v . pos_name }} - EWS : @{{ v.detail_ews[0].ews_location }}</span>
                    <span ng-if="v.detail['waterlevel'].status != 'normal' && v.detail['waterlevel'].alarm_status == 4" style="font-size:18px;" class="text-bold m-l-5 blink_orange">WL : @{{ v . pos_name }} - EWS : @{{ v.detail_ews[0].ews_location }}</span>
                    <span ng-if="v.detail['waterlevel'].status != 'normal' && (v.detail['waterlevel'].alarm_status >= 5 && v.detail['waterlevel'].alarm_status < 8)" style="font-size:18px;" class="text-bold m-l-5 blink_red">WL : @{{ v . pos_name }} - EWS : @{{ v.detail_ews[0].ews_location }}</span>
                </div>
                <div class="col-lg-1 col-md-1 col-sm-1 m-0 p-r-0 p-b-0 p-l-0 p-t-5 text-right" style="border:none">
                    <a href="" style="cursor: pointer" title="Open Full Windows">
                        <img src="{{ url('coloradmin') }}/assets/icon/expand-arrows.png" width="18px;" alt="" style="" ng-click="oExpand(v.hardware)" />
                    </a>
                </div>
            </div>
            <div class="col-lg-8 col-md-8 col-sm-12 m-0 p-0" style="">
                <div id="gallery" class="col-lg-12 col-md-12 col-sm-12 gallery m-0 p-2" style="">
                    <div class="image gallery-group-1 m-0" style="width: 100%;padding:0;border-radius: 5px">
                        <div class="image-inner">
                            <a ng-if="v.device_img == NULL" href="{{ url('coloradmin') }}/assets/img/cctv.jpg" data-lightbox="gallery-group-1">
                                <img ng-if="v.device_img == NULL" src="{{ url('coloradmin') }}/assets/img/cctv.jpg" alt="" style="border-radius:5px;height:100%" />
                            </a>
                            <a ng-if="v.device_img != NULL" href="{{ url('device_img') }}/@{{ v . device_img . img_name }}" data-lightbox="gallery-group-1">
                                <img ng-if="v.device_img != NULL" src="{{ url('device_img') }}/@{{ v . device_img . img_name }}" alt="" style="border-radius:5px;height:100%" />
                            </a>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 m-0 p-0" style="">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 m-0 p-3 text-center" style="">
