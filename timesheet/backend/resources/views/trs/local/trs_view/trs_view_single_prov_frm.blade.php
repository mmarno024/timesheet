@extends('layouts.colorreport_blank')
@section('content')
<link href="{{ url('coloradmin') }}/assets/css/style_single_prov.css" rel="stylesheet" />
    <style type="text/css">
    ...
    ?>
    <audio autoplay ng-if="data_hardware.detail['waterlevel'].alarm_status >= 3" loop>
        <source src="{{ url('sound') }}/beep5.mp3" type="audio/mpeg">
    ...
    <div class="col-lg-12 col-12 m-0 p-2" style="">
        <div class="col-lg-12 col-12 m-0 p-2 bg-white" style="border-radius: 5px;">
            ...
            <div class="col-lg-2 col-12 m-0" style="text-align: right;padding:8px 5px 8px 0;">
                <a href="{{ url('home') }}" class="btn btn-sm btn-primary" style="border:none"><i class="fa fa-user-circle"></i> Administrator</a>
            </div>
        </div>
    </div>
    <div class="col-lg-12 col-12 m-0 p-2">
        ...
        <div class="col-lg-8 col-12 m-0 p-2 bg-black text-right" style="border-radius: 5px;">
            <span style="font-size:2.5vh;" ng-if="notif_text != 'normal' && data_hardware.detail['waterlevel'].alarm_status == 3" class="text-bold button_alarm_yellow p-t-2 p-r-10 p-b-2 p-l-10">AWAS ! LEVEL AIR MEMBERIKAN SINYAL PERINGATAN @{{data_hardware.detail['waterlevel'].status}}</span>
            <span style="font-size:2.5vh;" ng-if="notif_text != 'normal' && data_hardware.detail['waterlevel'].alarm_status == 4" class="text-bold button_alarm_orange p-t-2 p-r-10 p-b-2 p-l-10">AWAS ! LEVEL AIR MEMBERIKAN SINYAL PERINGATAN @{{data_hardware.detail['waterlevel'].status}}</span>
            <span style="font-size:2.5vh;" ng-if="notif_text != 'normal' && data_hardware.detail['waterlevel'].alarm_status >= 5" class="text-bold button_alarm_red p-t-2 p-r-10 p-b-2 p-l-10">AWAS ! LEVEL AIR MEMBERIKAN SINYAL PERINGATAN @{{data_hardware.detail['waterlevel'].status}}</span>
            <span style="font-size:2.5vh;" ng-if="notif_text == 'normal'" class="text-bold btn btn-success p-t-2 p-r-10 p-b-2 p-l-10">LEVEL AIR DALAM KEADAAN AMAN</span>
        </div>
    </div>
        ...
        <div class="col-lg-12 col-12 m-0 p-2 bg-white" style="border-radius: 5px;">
            <div class="col-lg-12 col-12 m-0 p-0">
                <div class="col-lg-11 col-12 m-0 p-r-0 p-b-0 p-l-0 p-t-5" style="border:none">
                    <span style="font-size:25px;" ng-if="data_hardware.detail['waterlevel'].status == 'normal'" class="text-primary text-bold m-l-5">WL : @{{ data_hardware . pos_name }} - EWS : @{{ data_hardware.detail_ews[0].ews_location }}</span>
                    <span style="font-size:25px;-webkit-text-stroke: 0.1px black" ng-if="data_hardware.detail['waterlevel'].status != 'normal' && data_hardware.detail['waterlevel'].alarm_status == 3" class="text-bold m-l-5 blink_yellow">WL : @{{ data_hardware . pos_name }} - EWS : @{{ data_hardware.detail_ews[0].ews_location }}</span>
                    <span style="font-size:25px;" ng-if="data_hardware.detail['waterlevel'].status != 'normal' && data_hardware.detail['waterlevel'].alarm_status == 4" class="text-bold m-l-5 blink_orange">WL : @{{ data_hardware . pos_name }} - EWS : @{{ data_hardware.detail_ews[0].ews_location }}</span>
                    <span style="font-size:25px;" ng-if="data_hardware.detail['waterlevel'].status != 'normal' && (data_hardware.detail['waterlevel'].alarm_status >= 5 && data_hardware.detail['waterlevel'].alarm_status < 8)" class="text-bold m-l-5 blink_red">WL : @{{ data_hardware . pos_name }} - EWS : @{{ data_hardware.detail_ews[0].ews_location }}</span>
                </div>
                <div class="col-lg-1 m-0 p-r-5 p-t-5 text-right" style="">
                    <a href="" style="cursor: pointer" title="Close Full Windows">
                        <img src="{{ url('coloradmin') }}/assets/icon/compress-arrows.png" width="22px;" alt="" style="" ng-click="oCompress()" />
                    </a>
                </div>
            </div>
                ...
                <div id="gallery" class="col-lg-12 col-12 gallery m-0 p-5">
                    <div class="image gallery-group-1 m-0" style="width: 100%;padding:0;border-radius: 5px">
                        <div class="image-inner">
                            <a ng-if="data_hardware.device_img == NULL" href="{{ url('coloradmin') }}/assets/img/cctv.jpg" data-lightbox="gallery-group-1">
                                <img style="border-radius:5px;height:100%;" ng-if="data_hardware.device_img == NULL" src="{{ url('coloradmin') }}/assets/img/cctv.jpg" alt="" />
                            </a>
                            <a ng-if="data_hardware.device_img != NULL" href="{{ url('device_img') }}/@{{ data_hardware . device_img . img_name }}" data-lightbox="gallery-group-1">
                                <img style="border-radius:5px;height:100%;" ng-if="data_hardware.device_img != NULL" src="{{ url('device_img') }}/@{{ data_hardware . device_img . img_name }}" alt=""/>
                            </a>
            ...
            <div class="col-lg-6 col-12 m-0 p-0" style="">
                <div class="col-lg-12 col-12 m-0" style="padding:0 5px 0 5px;">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 m-0 p-0">
                        <span class="text-primary" style="font-size: 14px;"><i class="fa fa-calendar"></i> @{{ data_hardware.time_local }}</span>
                    </div>
                ...
                <div class="col-lg-12 col-12 m-0 p-0" style="">
                    <div class="col-lg-8 col-12 m-0 p-3 text-center" style="">
                        <div class="col-lg-12 col-12 m-0 p-0" style="">
                    ...
                    <div class="col-lg-4 col-12 m-0 p-3 text-center" style="">
                ...
                <div class="col-lg-12 col-12 m-0" style="padding:0 5px 0 5px;">
                    ...
                    <span style="font-size:18px" ng-if="data_hardware.detail['waterlevel'].status == 'normal' && data_hardware.detail['waterlevel'].btn_type == 1" class="text-success"><b>OFF</b></span>
                    <span style="font-size:18px" ng-if="data_hardware.detail['waterlevel'].status == 'normal' && (data_hardware.detail['waterlevel'].btn_type == 2 || data_hardware.detail['waterlevel'].btn_type == 5)" class="text-success">MENUNGGU RESPON</span>
                    <span style="font-size:18px" ng-if="data_hardware.detail['waterlevel'].status == 'normal' && (data_hardware.detail['waterlevel'].btn_type == 3 || data_hardware.detail['waterlevel'].btn_type == 6)" class="text-success">RESPON GAGAL</span>
                    <span style="font-size:18px" ng-if="data_hardware.detail['waterlevel'].status == 'normal' && data_hardware.detail['waterlevel'].btn_type == 4 && data_hardware.detail_ews[0].ews_sirine_level == 8" class="text-success"><b>ON</b> UJI SIRINE</span>
                    <span style="font-size:18px" ng-if="data_hardware.detail['waterlevel'].status == 'normal' && data_hardware.detail['waterlevel'].btn_type == 4 && data_hardware.detail_ews[0].ews_sirine_level == 9" class="text-success"><b>ON</b> AMAN</span>
                    <span style="font-size:18px" ng-if="data_hardware.detail['waterlevel'].status != 'normal' && data_hardware.detail['waterlevel'].btn_type == 1" class="text-danger"><b>OFF</b></span>
                    <span style="font-size:18px" ng-if="data_hardware.detail['waterlevel'].status != 'normal' && (data_hardware.detail['waterlevel'].btn_type == 2 || data_hardware.detail['waterlevel'].btn_type == 5)" class="text-danger">MENUNGGU RESPON</span>
                    <span style="font-size:18px" ng-if="data_hardware.detail['waterlevel'].status != 'normal' && (data_hardware.detail['waterlevel'].btn_type == 3 || data_hardware.detail['waterlevel'].btn_type == 6)" class="text-danger">RESPON GAGAL</span>
                    <span style="font-size:18px" ng-if="data_hardware.detail['waterlevel'].status != 'normal' && data_hardware.detail['waterlevel'].btn_type == 4 && data_hardware.detail_ews[0].ews_sirine_level == 1" class="text-danger"><b>ON</b> KUNING WASPADA</span>
                    <span style="font-size:18px" ng-if="data_hardware.detail['waterlevel'].status != 'normal' && data_hardware.detail['waterlevel'].btn_type == 4 && data_hardware.detail_ews[0].ews_sirine_level == 2" class="text-danger"><b>ON</b> ORANGE SIAGA</span>
                    <span style="font-size:18px" ng-if="data_hardware.detail['waterlevel'].status != 'normal' && data_hardware.detail['waterlevel'].btn_type == 4 && data_hardware.detail_ews[0].ews_sirine_level == 3" class="text-danger"><b>ON</b> MERAH AWAS</span>
                </div>
                ...
                <div class="col-lg-12 col-12 m-b-0" style="border:none;padding:0 5px 0 5px;">
                    ...
                    <div class="col-lg-10 col-10 m-0 p-t-5 p-r-0 p-b-5 p-l-5 text-right">
                        <span style="font-size:18px;" ng-if="data_hardware.detail['waterlevel'].status == 'normal' && data_hardware.detail['waterlevel'].btn_status == 'off' && data_hardware.detail['waterlevel'].btn_type == 1 && data_hardware.detail_ews[0].ews_sirine == 0 && data_hardware.detail_ews[0].ews_sirine_reply == 0 && data_hardware.detail_ews[0].ews_status == 'normal' && data_hardware.detail_ews[0].ews_sirine_level == 0" class="btn btn-success text-white p-5" style="font-size:10px;" role="button" ng-click="oEwsUji(data_hardware.hardware)"><i class="fa fa-thumbs-up"></i>&nbsp; Uji coba / Pemberitahuan</span>
                        <span style="font-size:18px;" ng-if="data_hardware.detail['waterlevel'].status == 'normal' && data_hardware.detail['waterlevel'].btn_status == 'on' && data_hardware.detail['waterlevel'].btn_type == 2 && data_hardware.detail_ews[0].ews_sirine == 1 && data_hardware.detail_ews[0].ews_sirine_reply == 0 && data_hardware.detail_ews[0].ews_status == 'onproccess' && data_hardware.detail_ews[0].ews_sirine_level > 0" class="btn btn-success text-white p-5" style="font-size:10px;" role="button" ng-click="oEwsCancel(data_hardware.hardware)"><i class="fa fa-refresh fa-spin"></i>&nbsp; Perintah dikirim ! Batalkan ?</span>
                        <span style="font-size:18px;" ng-if="data_hardware.detail['waterlevel'].status == 'normal' && data_hardware.detail['waterlevel'].btn_status == 'off' && data_hardware.detail['waterlevel'].btn_type == 3 && data_hardware.detail_ews[0].ews_sirine == 0 && data_hardware.detail_ews[0].ews_sirine_reply == 0 && data_hardware.detail_ews[0].ews_status == 'failed' && data_hardware.detail_ews[0].ews_sirine_level > 0" class="btn btn-success text-white p-5" style="font-size:10px;" role="button" ng-click="oEwsUji(data_hardware.hardware)"><i class="fa fa-warning"></i>&nbsp; Terjadi kegagalan ! Ulangi ?</span>
                        <span style="font-size:18px;" ng-if="data_hardware.detail['waterlevel'].status == 'normal' && data_hardware.detail['waterlevel'].btn_status == 'on' && data_hardware.detail['waterlevel'].btn_type == 4 && data_hardware.detail_ews[0].ews_sirine == 1 && data_hardware.detail_ews[0].ews_sirine_reply == 1 && data_hardware.detail_ews[0].ews_status == 'on'
                        && data_hardware.detail_ews[0].ews_sirine_level > 0" class="btn btn-success text-white p-5" style="font-size:10px;" role="button" ng-click="oEwsOff(data_hardware.hardware)"><i class="fa fa-volume-up"></i>&nbsp; Sirine dinyalakan ! Matikan ?</span>
                        <span style="font-size:18px;" ng-if="data_hardware.detail['waterlevel'].status == 'normal' && data_hardware.detail['waterlevel'].btn_status == 'off' && data_hardware.detail['waterlevel'].btn_type == 5 && data_hardware.detail_ews[0].ews_sirine == 0 && data_hardware.detail_ews[0].ews_sirine_reply == 1 && data_hardware.detail_ews[0].ews_status == 'offproccess' && data_hardware.detail_ews[0].ews_sirine_level == 0" class="btn btn-success text-white p-5" style="font-size:10px;" role="button"><i class="fa fa-refresh fa-spin"></i>&nbsp; Proses mematikan sirine</span>
                        <span style="font-size:18px;" ng-if="data_hardware.detail['waterlevel'].status == 'normal' && data_hardware.detail['waterlevel'].btn_status == 'off' && data_hardware.detail['waterlevel'].btn_type == 6 && data_hardware.detail_ews[0].ews_sirine == 0 && data_hardware.detail_ews[0].ews_sirine_reply == 1 && data_hardware.detail_ews[0].ews_status == 'failed' && data_hardware.detail_ews[0].ews_sirine_level == 0" class="btn btn-success text-white p-5" style="font-size:10px;" role="button" ng-click="oEwsOff(data_hardware.hardware)"><i class="fa fa-warning"></i>&nbsp; Gagal mematikan ! Ulangi ?</span>
                        <span style="font-size:18px;" ng-if="data_hardware.detail['waterlevel'].status != 'normal' && data_hardware.detail['waterlevel'].btn_status == 'off' && data_hardware.detail['waterlevel'].btn_type == 1 && data_hardware.detail_ews[0].ews_sirine == 0 && data_hardware.detail_ews[0].ews_sirine_reply == 0 && data_hardware.detail_ews[0].ews_status == 'warning' && data_hardware.detail_ews[0].ews_sirine_level == 0" class="btn btn-danger text-white p-5" style="font-size:10px;" role="button" ng-click="oEwsOn(data_hardware.hardware)"><i class="fa fa-warning"></i>&nbsp; Nyalakan sirine !</span>
                        <span style="font-size:18px;" ng-if="data_hardware.detail['waterlevel'].status != 'normal' && data_hardware.detail['waterlevel'].btn_status == 'on' && data_hardware.detail['waterlevel'].btn_type == 2 && data_hardware.detail_ews[0].ews_sirine == 1 && data_hardware.detail_ews[0].ews_sirine_reply == 0 && data_hardware.detail_ews[0].ews_status == 'onproccess' && data_hardware.detail_ews[0].ews_sirine_level > 0" class="btn btn-danger text-white p-5" style="font-size:10px;" role="button" ng-click="oEwsCancel(data_hardware.hardware)"><i class="fa fa-refresh fa-spin"></i>&nbsp; Perintah dikirim ! Batalkan ?</span>
                        <span style="font-size:18px;" ng-if="data_hardware.detail['waterlevel'].status != 'normal' && data_hardware.detail['waterlevel'].btn_status == 'off' && data_hardware.detail['waterlevel'].btn_type == 3 && data_hardware.detail_ews[0].ews_sirine == 0 && data_hardware.detail_ews[0].ews_sirine_reply == 0 && data_hardware.detail_ews[0].ews_status == 'failed' && data_hardware.detail_ews[0].ews_sirine_level > 0" class="btn btn-danger text-white p-5" style="font-size:10px;" role="button" ng-click="oEwsOn(data_hardware.hardware)"><i class="fa fa-warning"></i>&nbsp; Terjadi kegagalan ! Ulangi ?</span>
                        <span style="font-size:18px;" ng-if="data_hardware.detail['waterlevel'].status != 'normal' && data_hardware.detail['waterlevel'].btn_status == 'on' && data_hardware.detail['waterlevel'].btn_type == 4 && data_hardware.detail_ews[0].ews_sirine == 1 && data_hardware.detail_ews[0].ews_sirine_reply == 1 && data_hardware.detail_ews[0].ews_status == 'on'
                        && data_hardware.detail_ews[0].ews_sirine_level > 0" class="btn btn-danger text-white p-5" style="font-size:10px;" role="button" ng-click="oEwsOff(data_hardware.hardware)"><i class="fa fa-volume-up"></i>&nbsp; Sirine dinyalakan ! Matikan ?</span>
                        <span style="font-size:18px;" ng-if="data_hardware.detail['waterlevel'].status != 'normal' && data_hardware.detail['waterlevel'].btn_status == 'off' && data_hardware.detail['waterlevel'].btn_type == 5 && data_hardware.detail_ews[0].ews_sirine == 0 && data_hardware.detail_ews[0].ews_sirine_reply == 1 && data_hardware.detail_ews[0].ews_status == 'offproccess' && data_hardware.detail_ews[0].ews_sirine_level == 0" class="btn btn-danger text-white p-5" style="font-size:10px;" role="button"><i class="fa fa-refresh fa-spin"></i>&nbsp; Proses mematikan sirine</span>
                        <span style="font-size:18px;" ng-if="data_hardware.detail['waterlevel'].status != 'normal' && data_hardware.detail['waterlevel'].btn_status == 'off' && data_hardware.detail['waterlevel'].btn_type == 6 && data_hardware.detail_ews[0].ews_sirine == 0 && data_hardware.detail_ews[0].ews_sirine_reply == 1 && data_hardware.detail_ews[0].ews_status == 'failed' && data_hardware.detail_ews[0].ews_sirine_level == 0" class="btn btn-danger text-white p-5" style="font-size:10px;" role="button" ng-click="oEwsOff(data_hardware.hardware)"><i class="fa fa-warning"></i>&nbsp; Gagal mematikan ! Ulangi ?</span>
                    </div>
                </div>
        ...
        app.controller('mainCtrl', ['$scope', '$http', '$interval', 'NgTableParams', 'SfService', 'FileUploader',
            function($scope, $http, $interval, NgTableParams, SfService, FileUploader) {
                ...
                $scope.oCompress = function() {
                    window.location = 'trs_local_trs_view_ap';
                }
