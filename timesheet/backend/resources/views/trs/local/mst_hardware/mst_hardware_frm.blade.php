                                ...
                                <table class="table table-condensed table-bordered m-0" style="white-space: nowrap;">
                                    <tr>
                                        ...
                                        <td width="85%" class="text-primary p-0">
                                            {{-- <input type="text" ng-model="v3.ews_id" placeholder="..."
                                                class="form-control input-sm no-border-text text-primary"
                                                ng-click="oLookup('d3_ews_id',v3)"> --}}
...
app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope, $http,
    ...
    SfService.setUrl("{{ url('trs_local_mst_hardware') }}");
    $scope.f = {
        crud: 'c',
        tab: 'list',
        trash: 0,
    ...
    $scope.oLookup = function(id, selector, obj) {
        switch (id) {
            case 'plant':
                ...
                break;
            case 'd1_kd_sensor':
                SfLookup("{{ url('trs_local_mst_sensor_lookup') }}",
                    function(id, name, jsondata) {
            ...
            case 'kd_kecamatan':
                ...
                break;
            case 'kd_desa':
                SfLookup("{{ url('trs_local_mst_desa_lookup') }}?kecamatan=" + $scope.h
                    .kd_kecamatan,
                    function(id, name, jsondata) {
                ...
                break;
            case 'd3_ews_id':
                SfLookup("{{ url('trs_local_mst_ews_lookup') }}",
                    function(id, name, jsondata) {
