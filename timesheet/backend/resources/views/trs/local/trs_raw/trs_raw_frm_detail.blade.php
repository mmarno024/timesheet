...
@section('content')
        ...
        <div class="panel-body">
            <div class="m-b-5 form-inline">
                <div class="col-sm-12 m-b-10">
                    <div class="row m-b-10" ng-show="f.tab=='list'">
                    ...
                    <div class="row" ng-show="f.tab=='list'">
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-3">
                            ...
                            <select ng-model="q.vqmode" class="form-control input-sm" style="background:aquamarine">
                                <option ng-repeat="vq in ['Interval Kirim','Perjam','Harian','Bulanan']">@{{ vq }}</option>
                            </select>
                        </div>
                        <div class="col-lg-2 col-md-3 col-sm-3">
                    ...
                    <div class="alert alert-warning" style="margin:10px 0 0 0;  ">
                        <span class="m-r-20"><i class="fa fa-id-card"></i>&nbsp;Logger : @{{data_logger.nm_logger}}</span>
                        <span class="m-r-20"><i class="fa fa-id-card"></i>&nbsp;Hardware : @{{data_logger.kd_hardware}}</span>
                        <span class="m-r-20"><i class="fa fa-map-marker"></i>&nbsp;Lokasi : @{{data_logger.location}}</span>
                        <span class="m-r-20"><i class="fa fa-calendar"></i>&nbsp;Data Terakhir : @{{data_logger.tlocal}}</span>
                    </div>
                    <div class="col-sm-12 p-0" style="margin:10px 0 0 0;">
                        <a href="{{ url('trs_local_trs_raw_detail_all') }}" class="text-bold m-0 p-0">Lihat detail Logger lainnya &raquo;</a>
                    </div>
                    <hr />
                </div>
            </div>
                ...
                <div class="col-sm-12 m-b-20" ng-if="result=='2'">
                    <div class="col-lg-2 col-md-4 col-sm-4" style="float: right">
                        <button type="button" class="btn btn-sm btn-danger btn-block"
                            ng-click="oPdf(kd_logger,data_logger.kd_hardware,q.date1,q.date2,q.vqmode)"><i
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-4" style="float: right">
                        <button type="button" class="btn btn-sm btn-success btn-block" ng-click="oXls(kd_logger,data_logger.kd_hardware,q.date1,q.date2,q.vqmode)""><i
                                class="fa fa-download"></i>&nbsp;Download Excel</button>
                    </div>
                </div>
                <div class="col-sm-12">
                        ...
                        <div class="col-sm-12 m-0 p-0">
                            <div id="div1" class="table-responsive">
                                <div class="" style="margin: 0 0 10px;  ">
                                    <span class="m-r-20"><i class="fa fa-id-card"></i>&nbsp;Logger : @{{data_logger.nm_logger}}</span>
                                    <span class="m-r-20"><i class="fa fa-id-card"></i>&nbsp;Hardware : @{{data_logger.kd_hardware}}</span>
                                    <span class="m-r-20"><i class="fa fa-map-marker"></i>&nbsp;Lokasi : @{{data_logger.location}} <i>(  @{{data_logger.latitude}},  @{{data_logger.longitude}})</i></span>
                                    <span class="m-r-20"><i class="fa fa-calendar"></i>&nbsp;Data Terakhir : @{{data_logger.tlocal}}</span>
                                </div>
                                <table class="table table-condensed table-bordered" style="white-space: nowrap;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="padding:3px;" class="text-center">Tanggal Aktual</th>
                                ...
                                <div class="col-sm-4" ng-repeat="v in data_img">
                                    <div class="image gallery-group-1" style="width: 100%;">
                                        <div ng-if="v.kd_logger=='1'" class="image-inner">
                                            <a href="{{ url('device_img') }}/awll/@{{ v . img_name }}"
                                                data-lightbox="gallery-group-1">
                                                <img src="{{ url('device_img') }}/awll/@{{ v . img_name }}" alt="" />
                                            </a>
                                            <p class="image-caption">@{{ v . kd_hardware }}</p>
                                        </div>
                                        <div ng-if="v.kd_logger=='2'" class="image-inner">
                                            <a href="{{ url('device_img') }}/arl/@{{ v . img_name }}"
                                                data-lightbox="gallery-group-1">
                                                <img src="{{ url('device_img') }}/arl/@{{ v . img_name }}" alt="" />
                                            </a>
                                            <p class="image-caption">@{{ v . kd_hardware }}</p>
                                        </div>
                                        <div ng-if="v.kd_logger=='3'" class="image-inner">
                                            <a href="{{ url('device_img') }}/gsm/@{{ v . img_name }}"
                                                data-lightbox="gallery-group-1">
                                                <img src="{{ url('device_img') }}/gsm/@{{ v . img_name }}" alt="" />
                                            </a>
                                            <p class="image-caption">@{{ v . kd_hardware }}</p>
                                        </div>
                                        <div ng-if="v.kd_logger=='8' || v.kd_logger=='9'" class="image-inner">
                                            <a href="{{ url('device_img') }}/gpa/@{{ v . img_name }}"
                                                data-lightbox="gallery-group-1">
                                                <img src="{{ url('device_img') }}/gpa/@{{ v . img_name }}" alt="" />
                                            </a>
                                            <p class="image-caption">@{{ v . kd_hardware }}</p>
                                        </div>
                                ...
                                <div class="col-sm-4" ng-repeat="v in data_img">
                                    <div class="image gallery-group-1" style="width: 100%;">
                                        <div ng-if="v.kd_logger=='5'" class="image-inner">
                                            <a href="{{ url('device_img') }}/telecam/@{{ v . img_name }}"
                                                data-lightbox="gallery-group-1">
                                                <img src="{{ url('device_img') }}/telecam/@{{ v . img_name }}"
                                                    alt="" />
                                            </a>
                                            <p class="image-caption">@{{ v . kd_hardware }}</p>
                                        </div>
    ...
    <script>
        app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope,
            ...
            $scope.kd_logger = "{{ $request->lg }}";
            $scope.kd_hardware = "{{ $request->hw }}";
            $scope.view_mode = "";
            ...
            $scope.oPdf = function(logger,hardware,date1,date2,vqmode) {
                window.open('trs_local_trs_raw_detail_pdf?lg='+ logger +'&hw=' + hardware + '&t1=' + moment(date1).format('YYYY-MM-DD 00:00:00') + '&t2=' + moment(date2).format('YYYY-MM-DD 23:59:59') + '&vq=' + vqmode);
            }

            $scope.oXls = function(logger,hardware,date1,date2,vqmode) {
                window.open('trs_local_trs_raw_detail_xls?lg='+ logger +'&hw=' + hardware + '&t1=' + moment(date1).format('YYYY-MM-DD 00:00:00') + '&t2=' + moment(date2).format('YYYY-MM-DD 23:59:59') + '&vq=' + vqmode);
            }
