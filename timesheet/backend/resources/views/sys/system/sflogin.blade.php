...
<head>
    <meta charset="utf-8" />
    <title>{{ \App\Sf::getParsys('APP_WEB_COMPANY_NAME') }}</title>
    ...
    <link href="{{ url('coloradmin') }}/assets/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" />
    <link href="{{ url('coloradmin') }}/assets/css/animate.min.css" rel="stylesheet" />
    <link href="{{ url('coloradmin') }}/assets/css/style.min.css" rel="stylesheet" />
...
<body class="pace-top">
    ...
    <div class="login-cover">
        <div class="login-cover-image"><img src="{{ url('coloradmin') }}/assets/img/photos/2.jpg"
        ...
        <div class="login login-v2" data-pageload-addclass="animated fadeIn">
            ...
            <div class="login-header">
                <div class="brand text-center">
                    <img src="{{ url('coloradmin') }}/assets/img/fav.png"></img>
                    {{ \App\Sf::getParsys('APP_LABEL') }}
                    <small>Timesheet System Access</small>
                </div>
                <div class="icon">
            ...
            <div class="login-content">
                <form action="{{ url('/login') }}" method="POST" class="form-material mb-1">
                    {{ csrf_field() }}
    ...
    <!--[if lt IE 9]>
  <script src="{{ url('coloradmin') }}/assets/crossbrowserjs/html5shiv.js"></script>
  <script src="{{ url('coloradmin') }}/assets/crossbrowserjs/respond.min.js"></script>
  <script src="{{ url('coloradmin') }}/assets/crossbrowserjs/excanvas.min.js"></script>
 <![endif]-->
    ...
    <!-- ================== BEGIN PAGE LEVEL JS ================== -->
    <script src="{{ url('coloradmin') }}/assets/js/login-v2.demo.min.js"></script>
