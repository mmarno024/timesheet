                                ...
                                <h3 class="panel-title" style="border-radius:0">
                                    <a class="accordion-toggle accordion-toggle-styled" data-toggle="collapse"
                                        ...
                                        <img ng-show="v.kd_logger=='1'"
                                            src="{{ url('colorparalax/assets/img/device_blue.png') }}" width="15"
                                            height="15"></img>
                                        <img ng-show="v.kd_logger=='2'"
                                            src="{{ url('colorparalax/assets/img/device_green.png') }}" width="15"
                                            height="15"></img>
                                        <img ng-show="v.kd_logger=='9'"
                                            src="{{ url('colorparalax/assets/img/device_yellow.png') }}" width="15"
                                            height="15"></img>
                                        @{{ v . nm_logger }}
                                    </a>
                                </h3>
                                ...
                                <div class="panel-body">
                                    <div class="list-group" style="border-radius: 0">
                                        <a style="font-size: 11px;border-radius: 0;" ng-repeat="(k1,v1) in v.hardware"
                                            ...
                                            ng-click="oView(k,k1)">
                                            {{-- <img ng-show="v.kd_logger=='1'"
                                                src="{{ url('colorparalax/assets/img/marker_blue.png') }}"
                                                width="17"></img>
                                            <img ng-show="v.kd_logger=='2'"
                                                src="{{ url('colorparalax/assets/img/marker_green.png') }}"
                                                width="17"></img>
                                            <img ng-show="v.kd_logger=='9'"
                                                src="{{ url('colorparalax/assets/img/marker_yellow.png') }}"
                                                width="17"></img>
                                            &nbsp;<span
                                                ng-class="{'text-warning':v.kd_logger=='1','text-danger':v.kd_logger=='2','text-green':v.kd_logger=='9'}">@{{ v1 . kd_hardware }}</span>
                                            -
                                            @{{ v1 . uid }}
                                            <span
                                                ng-class="{'badge text-primary':v.kd_logger=='1','badge text-green':v.kd_logger=='2','badge text-warning':v.kd_logger=='9'}"
                                            ...
                                            <img ng-show="v.kd_logger=='9'"
                                                ...
                                                width="17"></img>
                                            &nbsp;<span
                                                ng-class="{'text-primary':v.kd_logger=='1','text-success':v.kd_logger=='2','text-warning':v.kd_logger=='9'}">@{{ v1 . kd_hardware }}</span>
                                            -
                                            @{{ v1 . uid }}
                                            <span
                                                ng-class="{'badge text-primary':v.kd_logger=='1','badge text-success':v.kd_logger=='2','badge text-warning':v.kd_logger=='9'}"
                                                style="background: rgba(76, 175, 80, 0);">
                                                <i class="fa fa-chevron-right"></i>
                                            </span> --}}
                                            ...
                                            <table width='100%' border='0'>
                                                <tr>
                                                    ...
                                                    {{-- <td align="left">
                                                        <span style="font-size:10px;font-weight:none;border-radius:0;"
                                                            class="btn btn-success btn-xs text-right"><a
                                                                class="val_7s ">0000.00</a> mdpl
                                                        </span>
                                                    </td> --}}
                            ...
                            angular.forEach(item.hardware, function(item1, i1) {
                                ...
                                if (item.kd_logger == '1') {
                                    $scope.dataIcon = L.icon({
                                        iconUrl: "{{ url('colorparalax/assets/img/marker_blue.png') }}",
                                        iconSize: [40, 40]
                                    });
                                } else if (item.kd_logger == '2') {
                                    $scope.dataIcon = L.icon({
                                        iconUrl: "{{ url('colorparalax/assets/img/marker_green.png') }}",
                                        iconSize: [40, 40]
                                    });
                                } else if (item.kd_logger == '9') {
                                    $scope.dataIcon = L.icon({
                                        iconUrl: "{{ url('colorparalax/assets/img/marker_yellow.png') }}",
                                        iconSize: [40, 40]
                                    });
                                } else {
                                    $scope.dataIcon = L.icon({
