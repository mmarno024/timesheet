@extends('layouts.coloradmin_minifiedx')
<!-- ------------------------------------------------------------------------------- -->
@section('title')Data Logger @stop
<!-- ------------------------------------------------------------------------------- -->
...
<!-- ------------------------------------------------------------------------------- -->
@section('content')
    <div class="panel panel-primary panel-expand">
        ...
        <div class="panel-body">
            ...
            <div ng-show="f.tab=='list'">
                <div class="form-inline   m-b-15">
                    ...
                    <button type="button" class="btn btn-sm btn-primary" ng-click="oSearch()">Refresh</button>
                    <hr>
                </div>
    ...
    <script>
        app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', function($scope, $http,
            ...
            SfService.setUrl("{{ url('trs_local_tr_raw') }}");
            $scope.f = {
                crud: 'c',
                tab: 'list',
                trash: 0,
            ...
            $scope.oLookup = function(id, selector, obj) {
                switch (id) {
                    case 'id_instansi':
                        SfLookup("{{ url('trs_local_ms_instansi_lookup') }}?plant=" + $scope.f.plant,
