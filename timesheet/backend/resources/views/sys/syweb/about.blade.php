...
@section('content')
    ...
    <div id="quote" class="content bg-black-darker has-bg" data-scrollview="true" style="padding-top:120px">
        ...
        <div class="content-bg">
            <img src="{{ url('colorparalax') }}/assets/img/quote-bg.jpg" alt="Quote" />
        </div>
        <!-- end content-bg -->
        <!-- begin container -->
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    ...
                    <div class="about-author">
                        ...
                        <div class="author">
                            <div class="image">
                                <img src="{{ url('colorparalax') }}/assets/img/user-1.jpg" alt="Sean Ngu" />
                            </div>
                            <div class="info">
                                Sean Ngu
                ...
                <div class="col-md-4 col-sm-12">
                    ...
                    <div class="skills">
                        ...
                        <div class="progress progress-striped">
                            <div class="progress-bar progress-bar-primary" style="width: 95%">
                        ...
                        <div class="progress progress-striped">
                            <div class="progress-bar progress-bar-primary" style="width: 85%">
    ...
    <div id="client" class="content has-bg bg-green" data-scrollview="true">
        <!-- begin content-bg -->
        <div class="content-bg">
            <img src="{{ url('colorparalax') }}/assets/img/client-bg.jpg" alt="Client" />
        </div>
        <!-- end content-bg -->
        <!-- begin container -->
