...
<span ng-show="f.tab=='audit'">Security Audit</span> @stop
<!-- ------------------------------------------------------------------------------- -->
@section('content')
    <style type="text/css">
    ...
    <script>
        app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', function($scope, $http, NgTableParams,
            SfService) {
            SfService.setUrl("{{ url('sys_sylink') }}");
            $scope.f = {
                crud: 'c',
                tab: 'dash',
                trash: 0,
            ...
            $scope.oLookup = function(id, selector, obj) {
                switch (id) {
                    case 'group':
                        SfLookup("{{ 'sys_sygroup_lookup' }}", function(id, name, jsondata) {
                        ...
                        break;
                    case 'dept':
                        SfLookup("{{ 'sys_sydept_lookup' }}?plant=" + $scope.f.plant, function(id, name,
                            jsondata) {
                            $("#" + selector).val(id).trigger('input');
                            $scope.oLoadDash();
                        ...
                        break;
                    case 'user':
                        SfLookup("{{ 'sys_syuser_lookup' }}", function(id, name, jsondata) {
                            $("#" + selector).val(id).trigger('input');
                            $scope.oLoadDash();
                            $("#d_name").val(name).trigger('input');
                        });
