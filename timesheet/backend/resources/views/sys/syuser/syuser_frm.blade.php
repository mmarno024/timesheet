                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="thumbnail" ng-hide="h.url_img==null">
                                <img ng-src="{{ \App\Sf::fileFtpAuthUrl('') }}/@{{ h . url_img }}" alt="Image Profile">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="thumbnail" ng-hide="h.url_sign==null">
                                <img ng-src="{{ \App\Sf::fileFtpAuthUrl('') }}/@{{ h . url_sign }}" alt="Signature">
                            </div>
                        </div>
                    </div>
        ...
        app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope, $http,
            ...
            $scope.oSyncLdap = function() {
                swal({
                    ...
                    preConfirm: () => {
                        return fetch("{{ url('sys_syuser_syncldap') }}")
