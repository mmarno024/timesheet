...
<!-- ------------------------------------------------------------------------------- -->
@section('title') {{ $syuser == false ? '' : ucwords(strtolower($syuser->username)) }} @stop
<!-- ------------------------------------------------------------------------------- -->
...
@section('content')
            ...
            <div class="tab-pane fade active in" id="tab-1">
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <h3>Photo</h3>
                        <div class="thumbnail">
                            <img ng-src="{{ \App\Sf::fileFtpAuthUrl('') }}/@{{ h . url_img }}">
                        </div>
                        <h3>Signature</h3>
                        <div class="thumbnail">
                            <img ng-src="{{ \App\Sf::fileFtpAuthUrl('') }}/@{{ h . url_sign }}">
                        </div>
                    </div>
                </div>
            </div>
            <div class="tab-pane fade in" id="tab-2">
                <div class="row">
                    <div class="col-sm-3" ng-repeat="v in m">
                        <div class="thumbnail">
                            <img ng-src="{{ \App\Sf::fileFtpAuthUrl('') }}/@{{ v . name }}">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope, $http,
            ...
            SfService.setUrl("{{ url('sys_syuser') }}");
            $scope.f = {
                crud: 'c',
                tab: 'list',
                trash: 0,
            ...
            $scope.oSearchLog = function(trash, order_by) {
                ...
                $scope.tableList = new NgTableParams({}, {
                    getData: function($defer, params) {
                        ...
                        return $http.get("{{ url('sys_sylog_list') }}", {
                            params: {
