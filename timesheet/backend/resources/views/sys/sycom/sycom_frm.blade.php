...
@section('content')
                ...
                <div id="div1" class="table-responsive">
                    <table ng-table="tableList" show-filter="false" class="table table-condensed table-hover"
                        ...
                        <tr ng-repeat="v in $data" class="pointer" ng-click="oShow(v.com_code)">
                            <td title="'Com Code'" filter="{com_code: 'text'}" sortable="'com_code'">@{{ v . com_code }}
                            </td>
                            <td title="'Com Name'" filter="{com_name: 'text'}" sortable="'com_name'">@{{ v . com_name }}
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <form action="#" name="frm" id="frm">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <input type="text" ng-model="h.com_code" id="h_com_code" class="form-control input-sm" required
                                maxlength="10">
                        </div>
                        <div class="col-sm-4">
                            <label>Com Name</label>
                            <input type="text" ng-model="h.com_name" id="h_com_name" class="form-control input-sm" required
                                maxlength="30">
                        </div>
                        <div class="col-sm-4">
                        </div>
    ...
    <script>
        app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', function($scope, $http, NgTableParams,
            SfService) {
            SfService.setUrl("{{ url('sys_sycom') }}");
            $scope.f = {
                crud: 'c',
                tab: 'list',
                trash: 0,
