...
@section('content')
                ...
                <div id="div1" class="table-responsive">
                    <table ng-table="tableList" show-filter="false" class="table table-condensed table-hover"
                        ...
                        <tr ng-repeat="v in $data" class="pointer" ng-click="oShow(v.plant)">
                            ...
                            <td style="padding:6px;" title="'Folder URL'" filter="{note: 'text'}" sortable="">
                                @{{ v . note }}
                            </td>
                            <td style="padding:6px;" title="'Address'" filter="{addr: 'text'}" sortable="">
                                @{{ v . addr }}</td>
            ...
            <div ng-show="f.tab=='frm'">
                <form action="#" name="frm" id="frm">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="input-group">
                                <input type="text" ng-value="h.state+' | '+h.state_name" id="h_state"
                                    class="form-control input-sm" ng-readonly="true">
                                <div class="input-group-btn">
                                    <button class="btn btn-primary btn-sm" type="button"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="thumbnail" ng-hide="h.image==null">
                                <img ng-src="{{ \App\Sf::fileFtpAuthUrl('') }}/@{{ h . image }}" alt="Logo">
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <label>Favicon</label>
                        ...
                        <div class="col-sm-1">
                            ...
                            <div class="thumbnail" ng-hide="h.image_favicon==null">
                                <img ng-src="{{ \App\Sf::fileFtpAuthUrl('') }}/@{{ h . image_favicon }}"
                                    alt="Favicon Image">
                            </div>
                        </div>
                    </div>
                    <hr>
                    <h3 class="text-primary">Hardware List</h3>
                    <div class="list-group">
                                    ...
                                    <table class="table table-condensed table-bordered m-0" style="white-space: nowrap;">
                                        <tr>
                                            <td class="text-danger pointer" ng-click="oDelrow($index)" align="center">
                                                <span class="label label-danger">Delete Hardware</span>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                        ...
                        <button type="button" class="btn btn-sm btn-primary" ng-click="addRow();">Add Hardware</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope, $http,
            ...
            SfService.setUrl("{{ url('sys_syplant') }}");
            $scope.f = {
                crud: 'c',
                tab: 'list',
                trash: 0,
            ...
            $scope.oShow = function(id) {
                SfService.show(SfService.getUrl("/" + encodeURI(id) + "/edit"), {}, function(jdata) {
                    ...
                    $scope.h.state_name = jdata.data.h.rel_district.nm_kecamatan;
                    $scope.f.crud = 'u';
            ...
            $scope.oLookup = function(id, selector, obj) {
                switch (id) {
                    case 'com_code':
                        SfLookup("{{ url('sys_sycom_lookup') }}", function(id, name, jsondata) {
                            $("#" + selector).val(id).trigger('input');;
                        });
                        break;
                    case 'provice':
                        SfLookup("{{ url('trs_local_mst_provinsi_lookup') }}?plant=" + $scope.f.plant,
                        ...
                        break;
                    case 'city':
                        SfLookup("{{ url('trs_local_mst_kabupaten_lookup') }}?plant=" + $scope.f.plant +
                        ...
                        break;
                    case 'state':
                        SfLookup("{{ url('trs_local_mst_kecamatan_lookup') }}?plant=" + $scope.f.plant +
                        ...
                        break;
                    case 'kd_hardware':
                        SfLookup("{{ url('trs_local_mst_hardware_lookup3') }}",
                            function(id, name, jsondata) {
