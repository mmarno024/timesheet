            ...
            <a style="height:100%;width:600px;" class="navbar-brand">
                <table border="0" cellspacing="">
                    <tr>
                        <td rowspan="2">
                            <a href="{{ url('home') }}">
                                <img src="{{ url('coloradmin/assets/img/logo-small.png') }}"></img>
                            </a>
                        </td>
                        <td rowspan="2">&nbsp;</td>
                        <td style="font-weight:bold;color:#0059b3;font-size:17px;line-height:1;border:none">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown navbar-user">
                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
                    <img src="{{ Auth::check() && Auth::user()->url_img != null ? \App\Sf::fileFtpUrl(Auth::user()->url_img) : url('coloradmin/assets/img/user-13.jpg') }}"
                        onerror="this.src='{{ url('coloradmin/assets/img/ionic.png') }}'" />
                    <span
                        class="hidden-xs">{{ ucwords(strtolower(Auth::check() ? Auth::user()->username : 'Guest')) }}</span>
                    <b class="caret"></b>
                </a>
                <ul class="dropdown-menu animated fadeInLeft">
                    <li class="arrow"></li>
                    <li><a href="{{ url('sys_system_profile') }}">Edit Profile</a></li>
                    <li class="divider"></li>
                    <li class="hidden"><a href="{{ route('logout') }}"
                    ...
                    <li><a href="{{ url('sflogout') }}">Log Out</a></li>
                </ul>
            </li>
        </ul>
    </div>
...
<script>
    app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope, $http,
        ...
        SfService.setUrl("{{ url('trs_local_mst_desa') }}");
        $scope.f = {
            crud: 'c',
            tab: 'list',
            trash: 0,
