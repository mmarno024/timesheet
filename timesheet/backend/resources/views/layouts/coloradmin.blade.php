...
<head>
    ...
    <link href="{{ url('coloradmin') }}/assets/css/overide.css?ver=2020.11.18" rel="stylesheet" id="theme" />
    <link href="{{ url('coloradmin') }}/assets/plugins/tags/bootstrap-tagsinput.css" rel="stylesheet" />
    <!-- ================== END BASE CSS STYLE ================== -->
...
<body ng-app="sfApp" ng-controller="topCtrl" id="topCtrl">
    ...
    <script src="{{ url('coloradmin') }}/assets/plugins/tags/bootstrap-tagsinput.min.js"></script>
    <script src="{{ url('coloradmin') }}/assets/plugins/tags/bootstrap-tagsinput-angular.min.js"></script>
    <!-- ================== END BASE JS ================== -->
    <!-- ================== BEGIN PAGE LEVEL JS ================== -->
