...
@section('content')
    ...
    <div class="">
        <div class="row">
            ...
            <div ng-if="total_hardware.total_gpa!=0" class="col-md-3 col-sm-6">
                <div class="widget widget-stats bg-orange">
                    ...
                    <div class="stats-link">
                        <a href="{{ url('/trs_local_mst_hardware') }}">View Detail <i class="fa fa-arrow-circle-o-right"></i></a>
                    </div>
                </div>
            </div>
            <div ng-if="f.plant=='002'" class="col-md-3 col-sm-6">
                <div class="widget widget-stats bg-red">
                    ...
                    <div class="stats-link">
                        <a href="{{ url('/trs_local_trs_api') }}">View Detail <i class="fa fa-arrow-circle-o-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <hr/>
        <div class="row">
            {{-- <div id="map" class="p-0 m-0" style="height:400px;border-radius:5px;"></div> --}}
        </div>
    </div>
