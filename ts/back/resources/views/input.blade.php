        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" class>Input Timesheet</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="card rounded-0">
                    ...
                    <form action="{{ route('register') }}" method="post">
                        ...
                        <div class="card-body text-left"
                            style="font-size:14px;background-image: url('public/assets/images/membership.png');background-repeat: no-repeat;background-position: right bottom;">
                            @if (session('errors'))
                            ...
                            <div id="ipRow">
                                <div class="input-group input-group-sm col-sm-6 p-0 mb-1">
                                    <input type="text" name="ip_address[]" id="ip_address"
                                        ...
                                        autocomplete="off">
                                    <input type="hidden" name="ip_address[]" value="::1">
                                    <div class="input-group-append">
                                        <button id="removeIpRow" type="button"
                                ...
                                <div class="input-group input-group-sm col-sm-6 p-0 mb-1">
                                    <select class="form-control rounded-0" name="id_instansi[]" id="id_instansi"
                                        ...
                                        @foreach ($instansi as $key => $value)
                                            <option value="{{ $value->id_instansi }}">{{ $value->id_instansi }}
                                                -
                                                {{ $value->nm_instansi }}</option>
                                        @endforeach
                                    </select>
                                    <div class="input-group-append">
                                        <button id="removeIsRow" type="button"
                                            class="btn btn-sm btn-danger rounded-0"><i
                                                class="fa fa-trash-o"></i></button>
                                    </div>
                                </div>
                            ...
                            <div id="hwRow">
                                <div class="input-group input-group-sm col-sm-6 p-0 mb-1">
                                    <input type="text" name="hardware[]" id="hardware"
                                        class="form-control rounded-0 m-input" placeholder="Masukkan ID Hardware"
                                        autocomplete="off">
                                    <div class="input-group-append">
                                        <button id="removeHwRow" type="button"
                                            class="btn btn-sm btn-danger rounded-0"><i
                                                class="fa fa-trash-o"></i></button>
                                    </div>
                                </div>
                            ...
                            <div id="newHwRow"></div>
                            <button id="addHwRow" type="button" class="btn btn-sm btn-info rounded-0">Tambah
                                hardware</button>
                            <div class="form-group input-group-sm col-sm-6 p-0">
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary btn-block rounded-0">Register</button>
                        </div>
                    </form>
                </div>
            </div>
