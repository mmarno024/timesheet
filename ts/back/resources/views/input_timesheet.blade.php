        ...
        <div class="col-sm-12 mt-3 mb-5 p-0">
            <div class="card-deck">
                <div class="card rounded-0">
                    ...
                    <form action="{{ route('insert_timesheet') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body text-left" style="font-size:14px;">
                            ...
                            <div class="col-lg-12 col-12" style="margin:0;padding:0;">
                                <div class="col-lg-2 col-12" style="margin-bottom:10px;">
                                    ...
                                    @php 
                                        ...
                                        $today = $Y . '-' . $m . '-' . $d;
                                    @endphp
                                    <input type="date" value="{{ $today }}" name="tanggal_ts" id="tanggal_ts" class="form-control input-sm" required readonly style="padding:5px;font-size:14px;">
                                </div>
                                ...
                                <div class="col-lg-8 col-12" style="margin-bottom:10px;">
                                    <b>NAMA CUSTOMER : </b>
                                    <input type="text" name="customer" id="customer" class="form-control input-sm" required style="padding:5px;font-size:14px;">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-12">
                                <div class="table-responsive">
                                    <textarea class="form-control" name="note" id="tinymce" style="border-radius: 0;"></textarea>
                                </div>
                            </div>
                            <p>&nbsp;</p>
                            <div class="col-lg-12 col-12">
